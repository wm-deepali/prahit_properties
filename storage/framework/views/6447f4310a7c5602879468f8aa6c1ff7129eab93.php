...
<?php $__env->startSection('title'); ?>
    Manage Business Listings - <?php echo e($user->firstname . ' ' . $user->lastname); ?>
                ...
                <div class="col-md-12 col-xs-12">
                    <div class="content-header">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Manage Business Listings of - <?php echo e($user->firstname . ' ' . $user->lastname); ?></li>
                        </ol>
                    </div>
                </div>
            </div>
                            ...
                            <div class="card-block">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-fitems">
                                        ...
                                        <tbody>
                                            <?php if(isset($businessListings) && count($businessListings) > 0): ?>
                                                <?php $__currentLoopData = $businessListings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c => $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\web-mingo-project\prahit-properties\resources\views/admin/business-listing/list_by_user.blade.php ENDPATH**/ ?>