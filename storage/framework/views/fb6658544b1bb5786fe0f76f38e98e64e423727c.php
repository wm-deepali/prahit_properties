			...
			<div class="sidebar-menu">
			    <nav class="navbar navbar-expand-lg navbar-sd-sidebar">
			        ...
			        <div class="collapse navbar-collapse nav-side" id="navbarSidebar">
			            <ul class="navbar-nav">
			                <li class="nav-item">
			                    <a href="<?php echo e(url('builder/dashboard')); ?>" class="nav-link active">Dashboard <span class="sr-only">(current)</span></a>
			                </li>
			                <li class="nav-item">
			                    <a href="<?php echo e(url('builder/profile')); ?>" class="nav-link">Profile Settings</a>
			                </li>
							<li class="nav-item">
			                    <a href="<?php echo e(url('builder/properties')); ?>" class="nav-link">My Properties</a>
			                </li>
			                <li class="nav-item">
			                ...
			                <li class="nav-item">
                                            ...
                                            <form id="logout-form" action="<?php echo e(url('builder/logout')); ?>" method="POST" style="display: none;">
...
</script><?php /**PATH /home/parhitproperties/public_html/parhit-2021/resources/views/front/builder/sidebar.blade.php ENDPATH**/ ?>