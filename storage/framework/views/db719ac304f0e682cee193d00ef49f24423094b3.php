                                ...
                                <form id="packageForm">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" name="name" class="form-control" required value="<?php echo e($package->name); ?>">
                                        </div>

                                        <div class="col-md-4 mb-3">
                                            <label class="form-label">Price (₹) <span class="text-danger">*</span></label>
                                            <input type="text" name="price" class="form-control" value="<?php echo e($package->price); ?>" placeholder="e.g., 1,999/- for 3 Months" required>
                                        </div>

                                        <div class="col-md-4 mb-3">
                                            <label class="form-label">Validity</label>
                                            <input type="text" name="validity" class="form-control" value="<?php echo e($package->validity); ?>" placeholder="e.g., 30 Days or 3 Months">
                                        </div>
                                        ...
                                        <div id="property_fields" style="display:none;margin:15px;">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <input type="number" name="number_of_listing" class="form-control" value="<?php echo e($package->number_of_listing); ?>">
                                                </div>

                                                <div class="col-md-4 mb-3">
                                                    <label>Photos per Listing</label>
                                                    <input type="number" name="photos_per_listing" class="form-control" value="<?php echo e($package->photos_per_listing); ?>">
                                                </div>
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <select name="response_rate" class="form-control">
                                                        <?php $__currentLoopData = ['Normal','Standard','Upto 2 times more','Upto 4 times more']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($option); ?>" <?php echo e($package->response_rate == $option ? 'selected' : ''); ?>><?php echo e($option); ?></option>
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <select name="property_visibility" class="form-control">
                                                        <?php $__currentLoopData = ['Normal','Medium','High','Top Priority']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($option); ?>" <?php echo e($package->property_visibility == $option ? 'selected' : ''); ?>><?php echo e($option); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <select name="profile_visibility" class="form-control">
                                                        <?php $__currentLoopData = ['No','Normal','Featured']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($option); ?>" <?php echo e($package->profile_visibility == $option ? 'selected' : ''); ?>><?php echo e($option); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <select name="priority_in_search" class="form-control">
                                                        <?php $__currentLoopData = ['No','Medium','High','Top Priority']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($option); ?>" <?php echo e($package->priority_in_search == $option ? 'selected' : ''); ?>><?php echo e($option); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <select name="customer_support" class="form-control">
                                                        <?php $__currentLoopData = ['Email','Email & Phone','Email / Phone / Chat','Dedicated']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($option); ?>" <?php echo e($package->customer_support == $option ? 'selected' : ''); ?>><?php echo e($option); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                </div>
                                        ...
                                        <div id="service_fields" style="display:none;margin:15px;">
                                            ...
                                            <div class="row">
                                                ...
                                                <?php
                                                    $serviceFields = [
                                                        'business_listing', 'profile_page_with_contact', 'business_logo_banner',
                                                        'verified_badge', 'premium_badge', 'featured_in_top_provider', 'lead_alerts'
                                                    ];
                                                ?>
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <input type="number" name="total_services" class="form-control" value="<?php echo e($package->total_services); ?>">
                                                </div>
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <input type="number" name="image_upload_limit" class="form-control" value="<?php echo e($package->image_upload_limit); ?>">
                                                </div>
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <select name="lead_enquiries" class="form-control">
                                                        <?php $__currentLoopData = ['Limited','Moderate','High','Priority']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($option); ?>" <?php echo e($package->lead_enquiries == $option ? 'selected' : ''); ?>><?php echo e($option); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                </div>
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <textarea name="description" rows="3" class="form-control"><?php echo e($package->description); ?></textarea>
                                        </div>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <select name="is_active" class="form-control">
                                                <option value="1" <?php echo e($package->is_active ? 'selected' : ''); ?>>Active</option>
                                                <option value="0" <?php echo e(!$package->is_active ? 'selected' : ''); ?>>Inactive</option>
                                            </select>
                                        </div>
