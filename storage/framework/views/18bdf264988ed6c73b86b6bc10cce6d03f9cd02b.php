							...
							<div class="row">
								<div class="col-sm-4">
									<div class="property-main-img">
										<img src="<?php echo e(isset($property_detail->PropertyGallery[0]) ? url('/').'/'.$property_detail->PropertyGallery[0]->image_path : ''); ?>" class="img-fluid">
									</div>
								</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/parhitproperties/public_html/parhit-new/resources/views/front/property_detail.blade.php ENDPATH**/ ?>