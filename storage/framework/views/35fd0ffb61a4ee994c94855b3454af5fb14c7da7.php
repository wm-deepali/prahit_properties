        ...
        <div class="col-sm-9">
          <div class="invoice-card">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      ...
                      ?>
                      <span
                        class="badge bg-<?php echo e($status == 'success' ? 'success' : ($status == 'pending' ? 'warning' : 'danger')); ?> text-light">
            ...
            <div class="text-end mt-4">
              <a href="<?php echo e(route('invoice.download', $subscription->invoice->id)); ?>" class="btn-download">
