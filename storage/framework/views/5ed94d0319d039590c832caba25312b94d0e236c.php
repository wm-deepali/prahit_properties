                ...
                <div class="row">
                    <div class="col-sm-12">
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <a class="navbar-brand" href="<?php echo e(url('/')); ?>"><img src="<?php echo e(asset('images/logo.png')); ?>"
                                    class="img-fluid"></a>

                            <div class="location-navigate">
                                <a href="javascript:void(0)" data-toggle="modal" onclick="viewMoreCities()"><i
                                        class="fas fa-map-marker-alt"></i> <?php echo e(Cache::get('location-name')); ?></a>
                            </div>
                            ...
                            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                                ...
                                <ul class="navbar-nav m-auto mt-2 mt-lg-0">
                                    <li class="nav-item"><a class="nav-link"
                                            href="<?php echo e(url('/')); ?>/<?php echo e(Cache::get('location-name') ? Cache::get('location-name') : ''); ?>?category=<?php echo e(encrypt(22)); ?>">Buy</a>
                                    </li>
                                    <li class="nav-item"><a class="nav-link"
                                            href="<?php echo e(url('/')); ?>/<?php echo e(Cache::get('location-name') ? Cache::get('location-name') : ''); ?>?category=<?php echo e(encrypt(21)); ?>">Rent</a>
                                    </li>
                                    <li class="nav-item"><a class="nav-link"
                                            href="<?php echo e(url('/')); ?>/<?php echo e(Cache::get('location-name') ? Cache::get('location-name') : ''); ?>?category=<?php echo e(encrypt(20)); ?>">PG / Hostel</a>
                                    </li>
                                </ul>
                                    ...
                                    <ul class="side-btn">
                                        <?php if(auth()->guard()->check()): ?>
                                            <?php if(\Auth::user()->role == 'owner'): ?>
                                                <li><a href="<?php echo e(url('user/dashboard')); ?>"><i class="far fa-user"></i>
                                                        <?php echo e(Auth::user()->firstname); ?> <?php echo e(Auth::user()->lastname); ?></a></li>
                                            <?php elseif(\Auth::user()->role == 'builder'): ?>
                                                <li><a href="<?php echo e(url('builder/dashboard')); ?>"><i class="far fa-user"></i>
                                                        <?php echo e(Auth::user()->firstname); ?> <?php echo e(Auth::user()->lastname); ?></a></li>
                                            <?php elseif(\Auth::user()->role == 'agent'): ?>
                                                <li><a href="<?php echo e(url('agent/dashboard')); ?>"><i class="far fa-user"></i>
                                                        <?php echo e(Auth::user()->firstname); ?> <?php echo e(Auth::user()->lastname); ?></a></li>
                                            <?php endif; ?>

                                        <?php endif; ?>
                                        <?php if(auth()->guard()->guest()): ?>
                                            <li><a href="#" data-target="#signin" data-toggle="modal"><i
                                                        class="far fa-user"></i> Sign In</a></li>
                                        <?php endif; ?>
                                        <li><a href="<?php echo e(route('create_property')); ?>"><i class="fas fa-pencil-alt"></i>
                                                Post Property <span>FREE</span></a></li>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        ...
                                        <input type="number" class="text-control" placeholder="Enter Mobile No."
                                            name="mobile_number"
                                            value="<?php echo e(Auth::check() ? Auth::user()->mobile_number : ''); ?>" <?php echo e(Auth::check() ? "readonly" : ""); ?> required />
                                    </div>
                                </div>
    ...
    <div class="modal fade custom-modal" id="signin" tabindex="-1" role="dialog" aria-labelledby="signin"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                                    ...
                                    <form id="login_form" name="login_form">
                                        <div class="form-group row">
                                            <div class="col-sm-12">
                                                ...
                                                <input type="text" class="text-control"
                                                    placeholder="Enter Email / Mobile No." name="email" id="login-email"
                                                    required />
                                                <span class="loginwotp" id="login-type-otp"><a style="cursor: pointer;"
                                                        onclick="loginType('otp')">Login with OTP</a></span>
                                                <span class="loginwotp" id="login-type-password"><a
                                                        style="cursor: pointer;" onclick="loginType('password')">Login
                                                        with Password</a></span>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-sm-12" id="view-password">
                                                ...
                                                <a href="#" data-target="#forgot-password" data-toggle="modal"
                                                    data-dismiss="modal" class="forgotpass">Forgot Password ?</a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-12 text-center" id="check-otp">
                                                <button type="button" class="btn btn-send w-100"
                                                    onclick="sendLoginOtp()">Send OTP <i
                                                        class="fas fa-chevron-circle-right"></i></button>
                                            </div>
                                        </div>
                                        <?php echo csrf_field(); ?>
                ...
                <div class="modal-foo text-center">
                    <p>Don't have account? <a href="#" data-target="#register" data-toggle="modal"
                            data-dismiss="modal">Create an Account</a>
                    </p>
                </div>
            </div>
        </div>
    ...
    <footer>
                    ...
                    <div class="col-sm-6">
                        <div class="foo-left">
                            ...
                            <div class="foo-social-app">
                                <ul>
                                    <li><a href="<?php echo e($media->facebook); ?>" target="_blank"><i
                                                class="fab fa-facebook-f"></i></a>
                                    </li>
                                    <li><a href="<?php echo e($media->twitter); ?>" target="_blank"><i
                                                class="fab fa-twitter"></i></a>
                                    </li>
                                    <li><a href="<?php echo e($media->insta); ?>" target="_blank"><i
                                                class="fab fa-instagram"></i></a>
                                    </li>
                                    <li><a href="<?php echo e($media->youtube); ?>" target="_blank"><i
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <p>Copyright &copy; 2020 Parhit Properties. All Right Reserved | Design &amp; Developed By <a
