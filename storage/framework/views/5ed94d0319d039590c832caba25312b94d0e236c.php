...
<header class="main-header py-2 shadow-sm bg-white">
    <div class="container d-flex align-items-center justify-content-between">
        ...
        <div class="d-flex align-items-center gap-3" style="width:auto;gap:20px;">
            ...
            <!-- 🏗️ Post Property -->
            <a href="<?php echo e(route('create_property')); ?>" class="btn text-white fw-semibold px-3 py-1 rounded-3" style="background:#e38e32; height:38px;">
...
<!---->
                                      ...
                                      <?php if(auth()->guard()->check()): ?>
                                            <?php if(\Auth::user()->role == 'owner'): ?>
                                                <li>
                                                    <a href="<?php echo e(url('user/dashboard')); ?>" class="btn btn-outline-dark fw-semibold" data-bs-toggle="dropdown" aria-expanded="false">
            <i class="far fa-user-circle fs-4 me-1" style="font-size:18px;"></i>
             <?php echo e(Auth::user()->firstname); ?> <?php echo e(Auth::user()->lastname); ?>
                                            ...
                                            <li>
                                                    <a href="<?php echo e(url('builder/dashboard')); ?>" class="btn btn-outline-dark fw-semibold" data-bs-toggle="dropdown" aria-expanded="false">
            <i class="far fa-user-circle fs-4 me-1" style="font-size:18px;"></i>
             <?php echo e(Auth::user()->firstname); ?> <?php echo e(Auth::user()->lastname); ?>
                                            ...
                                            <?php elseif(\Auth::user()->role == 'agent'): ?>
                                             ...
                                             <li>
                                                    <a href="<?php echo e(url('agent/dashboard')); ?>" class="btn btn-outline-dark fw-semibold" data-bs-toggle="dropdown" aria-expanded="false">
            <i class="far fa-user-circle fs-4 me-1" style="font-size:18px;"></i>
            <?php echo e(Auth::user()->firstname); ?> <?php echo e(Auth::user()->lastname); ?>
              ...
              <div class="bb-tab-pane" id="rent-tab3">
                <div class="tab-content-top-header">
                  ...
                  <div class="tab-content-section">
                    ...
                    <div class="d-flex flex-column">
                      <?php $__currentLoopData = $rentBudgets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $budget): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route('listing.list', $budget['query'])); ?>"><?php echo e($budget['label']); ?></a>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                  </div>
                  <div class="tab-content-section">
