                ...
                <table class="table table-bordered table-fitems">
                  ...
                  <tbody>
                    <?php if(isset($technologies) && count($technologies) > 0): ?>
                      <?php $__currentLoopData = $technologies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  ...
  <div class="modal-dialog">
    <div class="modal-content"> 
      ...
      <div class="modal-body">
        <form method="post" action="<?php echo e(route('admin.storeJobTechnologies')); ?>">
          <?php echo csrf_field(); ?>
...
<div class="modal update_category_modal" id="update-category">
  <div class="modal-dialog">
    <div class="modal-content"> 
      ...
      <!-- Modal body -->
      <div class="modal-body">
        <form method="post" action="<?php echo e(route('admin.updateJobTechnologies')); ?>">
          <div class="form-group row">
            <div class="col-sm-12">
              <label class="label-control">Name</label>
...
$(function() {
  ...
  $(".btn-delete").on('click', function(e) {
      ...
      var route = "<?php echo e(route('admin.deleteJobTechnology', ['id' => ':id'])); ?>";
...
function fetchData(id){
  ...
  var route = "<?php echo e(route('admin.getTechnologyInfo', ':id')); ?>";
  var route = route.replace(":id", id);
...
function changeStatus(id) {
    ...
    .then((willDelete) => {
      if (willDelete) {
          ...
          $.ajax({
            url: '<?php echo e(route('admin.changeStatusTechnology')); ?>',
            method: "POST",
            data: {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/parhitproperties/public_html/parhit-2021/resources/views/admin/job/technologies.blade.php ENDPATH**/ ?>