...
<?php $__env->startSection('content'); ?>
	...
	<section class="contact-us-page">
									...
									<div class="col-lg-12 col-md-12">
										<div class="form-group">
											<label>
												...
												<a href="<?php echo e(route('front.termCondition')); ?>">Terms & Conditions</a> And
		...
		<div class="contact-three-part">
			<iframe src="<?php echo e($map_link->description); ?>" width="100%" height="350" style="border:0;" allowfullscreen=""
				loading="lazy"></iframe>
		</div>
	</section>
