			...
			<div class="col-sm-12">
				<div class="card">
					<div class="card-body">
						<div class="card-block">
							<form class="form-body" method="post" action="<?php echo e(url('master/web-directory-sub-category')); ?>/<?php echo e($picked->id); ?>">
              <?php echo csrf_field(); ?>
              <?php echo e(method_field('PATCH')); ?>
                        ...
                        <option value="">Select Category</option>
                          ...
                          <?php if($picked->category_id == $value->id): ?>
													   <option value="<?php echo e($value->id); ?>" cat-name="<?php echo e($value->category_name); ?>" selected=""> <?php echo e($value->category_name); ?> </option>
                          <?php else: ?>
                            <option value="<?php echo e($value->id); ?>" cat-name="<?php echo e($value->category_name); ?>"> <?php echo e($value->category_name); ?> </option>
                          <?php endif; ?>
												<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
											<?php else: ?>
									...
									<div class="col-sm-4">
										...
										<input type="text" placeholder="Enter Sub Category Name" id="sub_category_name" class="text-control" onkeyup="autoFilledSlug()" name="sub_category_name" value="<?php echo e($picked->sub_category_name); ?>" required />
									</div>
									<div class="col-sm-4">
										<label class="label-control">Sub Category Slug</label>
										<input type="text" placeholder="Enter Sub Category Slug" id="sub_category_slug" value="<?php echo e($picked->sub_category_slug); ?>" class="text-control" name="sub_category_slug" required />
									</div>
								</div>
                  ...
                  <div class="col-sm-4">
                    ...
                    <select class="text-control populate_subsubcategories" name="sub_sub_category_id" onchange="fetch_form_type();" >
                      ...
                      <?php $__currentLoopData = $p_sub_sub_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($picked->sub_sub_category_id == $v->id): ?>
                          <option value="<?php echo e($v->id); ?>" selected=""><?php echo e($v->sub_sub_category_name); ?></option>
                        <?php else: ?>
                          <option value="<?php echo e($v->id); ?>"><?php echo e($v->sub_sub_category_name); ?></option>
                        <?php endif; ?>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                  </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/parhitproperties/public_html/parhit-2021/resources/views/admin/web_directory/sub_categories/edit.blade.php ENDPATH**/ ?>