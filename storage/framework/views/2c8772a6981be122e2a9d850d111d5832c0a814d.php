    ...
    <div class="row">
      ...
      <div class="col-sm-9">
        <div class="main-area-dash">
          ...
          <div class="row g-3">
            <?php $__empty_1 = true; $__currentLoopData = $recentViews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
              <?php
                $p = $item->property;
              ?>
              <div class="col-md-4 mb-4">
                <div class="card wishlist-card">
                  ...
                  <div class="wishlist-info">
                    <h5><a href="<?php echo e(route('property_detail', ['id' => $p->id, 'slug' => $p->slug])); ?>"><?php echo e($p->title); ?></a></h5>
                    ...
                    <div class="property-actions">
                      <a href="<?php echo e(route('property_detail', ['id' => $p->id, 'slug' => $p->slug])); ?>"
...
<?php echo $__env->make('layouts.front.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\web-mingo-project\prahit-properties\resources\views/front/user/recent-viewed-properties.blade.php ENDPATH**/ ?>