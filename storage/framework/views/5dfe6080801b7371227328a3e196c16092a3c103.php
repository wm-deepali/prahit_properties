...
<div class="col-md-8">
    <div class="row g-4">
        ...
        <div class="col-12 col-lg-4">
            <div class="detail-box text-center p-3 rounded-3 bg-light border-start border-purple border-5">
                <div class="text-muted small fw-600"><?php echo e(optional($property_detail->getPropertyStatusObj())->second_input_label ?? 'Possession By'); ?></div>
                <div class="fw-bold text-dark fs-5">
                    <?php echo e($property_detail->property_status_second); ?>
    ...
    </div><?php /**PATH D:\web-mingo-project\prahit-properties\resources\views/front/property_sections/sell_builder_floor_apartment.blade.php ENDPATH**/ ?>