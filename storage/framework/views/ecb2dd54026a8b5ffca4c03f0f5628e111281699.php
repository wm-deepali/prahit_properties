...
<?php $__env->startSection('title'); ?>
  Manage Cancelled & Rejected Properties
...
<?php $__env->startSection('content'); ?>
      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          <div class="content-header">
            ...
            <a type="button" class="btn btn-primary btn-save" href="<?php echo e(route('admin.properties.create')); ?>"><i
                class="fas fa-plus"></i> Add Property</a>
            <button type="button" class="btn btn-primary btn-save mr-3" data-toggle="collapse" data-target="#showFilter"
              aria-expanded="false" aria-controls="showFilter"><i class="fas fa-sort-amount-down-alt"></i> Show
              Filters</button>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
              <li class="breadcrumb-item">Property</li>
              <li class="breadcrumb-item active">Manage Cancelled & Rejected Properties</li>
            </ol>
          </div>
        </div>
      </div>
                ...
                <div class="card-block">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-3 align-self-end">
                      ...
                      <button class="btn btn-filternow" type="button" onclick="reload()"><i class="fas fa-refresh"></i>
                        Reset</button>
                    </div>
                  </div>
                </div>
  ...
  <!-- View Reason -->
  <div id="view-property-reason" class="modal fade" role="dialog">
    <div class="modal-dialog">
...
<?php $__env->startSection('js'); ?>
  <script type="text/javascript">
    ...
    function cancelledProperties(queryParams = '?') {
      var route = '<?php echo e(route('admin.manageCancelledPropertiesDatatable')); ?>' + queryParams;
    ...
    $("#filter_form").submit(function (e) {
      ...
      cancelledProperties(queryParams);
    })
          ...
          if (response.status === 200) {
            ...
            if (
              ...
              $(".listing_thumbnail").attr(
                "src",
                "<?php echo e(config('app.url')); ?>/" + property.property_gallery[0].image_path
              );
            } else {
            ...
            if (status == 'Unpublish') {
              ...
              $.each(response.data.Property.property_gallery, function (key, image) {
                $("#render-images").append(`<div class="col-sm-3">
                                              <img src="<?php echo e(config('app.url')); ?>/${image.image_path}" style="height:50px;" /><br>
                                              <input type="checkbox" name="document" value="<?php echo e(config('app.url')); ?>/${image.image_path}" />
                                            </div>`);
              });
    ...
    function viewReason(id) {
      ...
      $.ajax({
        ...
        success: function (response) {
          var response = JSON.parse(response);
          if (response.status === 200) {
            $("#view-reason").text(response.data.Property.reason);
            $("#view-property-reason").modal('show');
          } else if (response.status === 400) {
            toastr.error(response.message)
          }
          $(".loading").css('display', 'none');
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\web-mingo-project\prahit-properties\resources\views/admin/properties/cancelled_properties.blade.php ENDPATH**/ ?>