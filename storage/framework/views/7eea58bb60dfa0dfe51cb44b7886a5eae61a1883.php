...
<section class="content-main-body">
        ...
        <div class="card-block">
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-4">
              ...
              <h5 class="content-h"><?php echo e($data->SubSubCategory ?  $data->SubSubCategory->sub_sub_category_name : 'N/A'); ?></h5>
            </div>
          </div>
          <div class="row mb-3">
            <div class="col-sm-4">
          ...
          <div class="row mb-3">
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-4">
                ...
                <h5 class="content-h"><?php echo e($data->getSubLocations($data->sub_location_id) ? $data->getSubLocations($data->sub_location_id) : 'N/A'); ?></h5>
              </div>
            </div>
            <div class="row mb-3">
              <div class="col-sm-12">
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-3">
                <a href="<?php echo e(asset('')); ?>/<?php echo e($value->image_path); ?>" target="_blank">
                  <img src="<?php echo e(asset('')); ?>/<?php echo e($value->image_path); ?>" alt="Property Images" class="img-fluid" style="height: 100px;"></a>
              </div>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              <?php else: ?>
  ...
  <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/parhitproperties/public_html/parhit-2021/resources/views/admin/properties/view.blade.php ENDPATH**/ ?>