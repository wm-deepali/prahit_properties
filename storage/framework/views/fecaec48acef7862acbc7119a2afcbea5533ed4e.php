            ...
            <div class="card-block">
              <div class="table-responsive">
                <table class="table table-bordered table-fitems">
                  ...
                  <tbody>
                    <?php $__currentLoopData = $keys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <tr>
                        ...
                        <td>
                            <ul class="action">
                              <li><a href="#" onclick="fetchData(<?php echo e($key->id); ?>);"><i class="fas fa-pencil-alt"></i></a></li>
                              <li><a href="#" data-toggle="modal" data-target="#delete-category" onclick="$('#delete_category #id').val(<?php echo e($key->id); ?>)"><i class="fas fa-trash"></i></a></li>
                            </ul>
                        </td>
                      </tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content"> 
      ...
      <div class="modal-body">
        <form method="post" action="<?php echo e(route('createVisionMission')); ?>">
          <?php echo csrf_field(); ?>
          <div class="form-group row">
            <div class="col-sm-12">
...
<div class="modal" id="update_category_modal">
  <div class="modal-dialog">
    <div class="modal-content"> 
      ...
      <!-- Modal body -->
      <div class="modal-body">
        <form method="post" action="<?php echo e(route('updateVisionMission')); ?>">
          <?php echo csrf_field(); ?>
          <div class="form-group row">
            <div class="col-sm-12">
              <label class="label-control">Heading</label>
...
$(function() {
  ...
  $(".btn-delete").on('click', function(e) {
      ...
      var route = "<?php echo e(route('deleteVisionMission', ['id' => ':id'])); ?>";
...
function fetchData(id){
  ...
  var route = "<?php echo e(route('admin.getkeyData', ':id')); ?>";
  var route = route.replace(":id", id);
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/parhitproperties/public_html/parhit-2021/resources/views/admin/vision/index.blade.php ENDPATH**/ ?>