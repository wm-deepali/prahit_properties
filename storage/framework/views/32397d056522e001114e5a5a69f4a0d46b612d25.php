...
<section class="property-search-filter">
    ...
    <div class="row justify-content-center">
      <div class="col-sm-8">
        <div class="search-head">
          ...
          <h5>continue your home search</h5> 
        </div>
          ...
          <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            <?php if(isset($category)): ?>
              <?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a=>$b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li class="nav-item"> <a class="nav-link <?php echo e($a==0 ? 'active' : ''); ?>" href="#" aria-selected="false"><?php echo e($b->category_name); ?></a> </li>
                  ...
                  <div class="row no-gutters">
                    <div class="col-sm-4">
                      <div class="form-group">
                        <input type="text" class="text-control" placeholder="Enter Location, Landmark" name="property" required />
                      </div>
                    </div>
                    <div class="col-sm-3">
                      <div class="form-group">
  ...
  <div class="men-prop"> <img src="<?php echo e(url('/public/images/srk.png')); ?>" class="img-fluid"> </div>
</section>
<?php
            ...
            <div class="city-main text-center">
                ...
                ?> 
      		      <a href="<?php echo e(url('/')); ?>/<?php echo e($get_city->name); ?>">
              		<div class="thumb"> <img class="img-fluid" src="<?php echo e(asset('storage')); ?>/<?php echo e($popular_city->image); ?>" alt="pc1.png"> </div>
              		<div class="details">
...
<section class="property-home-list">
  <div class="container">
    <div class="row">
      <div class="col-sm-12">
        <div class="section-title section-center">
          <h4>Hand picked projects for you</h4>
        </div>
      </div>
    </div>
    <div class="row">
					...
					<div class="property-list-01">
						<div class="property-img">
							<a href="<?php echo e(route('property_detail', ['title' => $value->slug])); ?>"> 
								<img src="<?php echo e(isset($value->PropertyGallery[0]->image_path) ? url('/public/').'/'.$value->PropertyGallery[0]->image_path : ''); ?>" class="img-fluid"> <span class="type-pro"><?php echo e(isset($value->property_types->type) ? $value->property_types->type : ''); ?></span><span class="price-pro">Rs. <?php echo e(number_format($value->price, 2)); ?></span> 
							</a>
						</div>
		...
		<div class="row">
			<div class="col-sm-12">
				<div class="section-title section-left">
					...
					<p>Most sought-after projects in Lucknow</p>
				</div>
			</div>
		</div>
		...
		<div class="row">
				...
				<div class="project-main">
					...
					<div class="image-proj">
						<img src="images/about-img.jpg" class="img-fluid">
					</div>
					
					<div class="info-proj">
						<h4 class="proj-name">The Legends</h4>
						<span class="develop-name">By Omax</span>
						<span class="apart-name">4BHK Apartment</span>
						<span class="apart-adress">Gomti Nagar, Lucknow</span>
						<div class="proj-price">
							<span><i class="fas fa-rupee-sign"></i> 2 Cr - 2.25 Cr</span>
						</div>
					</div>
					</a>
				</div>
	    	...
	    	<?php $__currentLoopData = $listings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		    	...
		    	<div class="col-sm-2">
			        <div class="property-gridsm">
			          	<div class="property-img"><a href="property-details.php"> <img src="<?php echo e(isset($value->PropertyGallery[0]->image_path) ? url('/public/').'/'.$value->PropertyGallery[0]->image_path : ''); ?>" class="img-fluid"> <span class="type-pro"><?php echo e(isset($value->property_types->type) ? $value->property_types->type : ''); ?></span><span class="price-pro">RRs. <?php echo e(number_format($value->price, 2)); ?></span> </a>
			          	</div>
			          	<div class="property-content">
			           		<div class="property-title">
			             		<h4><a href="property-details.php"><?php echo e($value->title); ?></a></h4>
			              		<a href="#" class="property-address"> <i class="fas fa-map-marker"></i> <?php echo e($value->address); ?> </a>
			              	</div>
				        </div>
			        </div>
...
<section class="featured-sold-section">
	<div class="container">
		<div class="row">
			<div class="col-sm-12">
				<div class="section-title section-center">
					<h4>Featured Property For Sale</h4>
					<p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium<br> voluptatum deleniti atque corrupti quos dolores
					</p>
				</div>
			</div>
		</div>
				...
				<div class="property-list-3">
					...
					<div class="listing-img-wrapper">
						<a href="property-detail.php">
							<img src="images/p-1.jpg" class="img-fluid mx-auto" alt="">
						</a>
					...
					<div class="listing-content">
						<div class="listing-detail-wrapper-box">
							<div class="listing-detail-wrapper">
								<div class="listing-short-detail">
									<h4 class="listing-name"><a href="property-detail.php">Resort Valley Ocs</a></h4>
								...
								<div class="list-price">
									<h6 class="listing-card-info-price"><i class="fas fa-rupee-sign"></i>7,000</h6>
								</div>
							</div>
						</div>
						...
						<div class="listing-footer-wrapper">
							<div class="listing-locate">
								<span class="listing-location"><i class="fas fa-map-marker-alt"></i> Quice Market, Canada</span>
							</div>
							<div class="listing-detail-btn">
								<a href="property-detail.php" class="more-btn">View</a>
							</div>
						</div>
  ...
  <div class="container">
    ...
    <div class="row">
		        ...
		        <div class="item">
		            <article class="quote-modern">
		              	<div class="quote-modern-inner">
			                <time class="quote-modern-time" datetime="2020"><?php echo e(date("jS F, Y", strtotime($testimonial->created_at))); ?></time>
			                <div class="quote-modern-main">
			                  	<p><?php echo e($testimonial->description); ?></p>
			                </div>
			                <div class="quote-modern-meta-outer">
			                	<img class="quote-modern-avatar" src="<?php echo e(asset('storage')); ?>/<?php echo e($testimonial->image); ?>" alt="" width="57" height="57" /> 
	  ...
	  <div class="col-sm-12 text-center mt-3">
		<button class="btn btn-feedback" type="button" data-target="#send-feedback" data-toggle="modal">Send Feedback</button>
	  </div>
    </div>
  </div>
</section>
    ...
    <div class="row justify-content-center">
      <div class="col-md-4">
        <div class="help-box box-1">
          ...
          <a class="btn btn-startweb" href="#"> Start Chat</a> </div>
      </div>
      <div class="col-md-4">
...
<div class="modal fade custom-modal" id="send-feedback" tabindex="-1" role="dialog" aria-labelledby="register" aria-hidden="true">
            ...
            <?php echo csrf_field(); ?>
  						...
  						<div class="form-group row">
  							...
  							<div class="col-sm-6">
  								...
  								<input type="number" class="text-control" name="mobile_number" placeholder="Enter Mobile No." required="">
  							</div>
  						</div>
                  ...
                  <input type="text" class="text-control" name="designation" placeholder="Enter Designation" required />
  						...
  						<div class="form-group row">
  							<div class="col-sm-12">
  								...
  								<textarea class="text-control" rows="4" cols="2" name="description" placeholder="Your Feedback here.." required=""></textarea>
  							</div>
  						</div>

  						<div class="form-group row">
  							<div class="col-sm-12 text-center">
  								<button type="submit" class="btn btn-send w-100">Send Feedback <i class="fas fa-chevron-circle-right"></i></button>
  							</div>
  						</div>
            </form>
					</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/parhitproperties/public_html/parhit-2021/resources/views/front/home.blade.php ENDPATH**/ ?>