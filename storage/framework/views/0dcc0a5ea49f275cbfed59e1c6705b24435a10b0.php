            ...
            <div class="col-lg-6 p-4">
                ...
                <form id="forgot_form">
                    ...
                    <div class="text-center mt-3">
                        <a href="<?php echo e(route('user.login')); ?>" class="back-login">← Back to Login</a>
                    </div>
...
<?php $__env->startSection('js'); ?>
    <script>
        function sendForgotOtp() {
            $.ajax({
                url: "<?php echo e(route('forgot.password.sendOtp')); ?>",
                method: "POST",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\web-mingo-project\prahit-properties\resources\views/front/user/forgot-password.blade.php ENDPATH**/ ?>