                ...
                <div class="row justify-content-center mt-5">
                    <div class="col-sm-12 col-md-12 col-lg-12 col-xs-12">
                        ...
                        <center class="modal_loading mt-2">
                            <img src="<?php echo e(asset('images/loading.gif')); ?>" alt="Loading.." class="modal_loading" style="width:40px; display:none;" />
                        </center>
                    </div>
                </div>
                    ...
                    <div class="row" id="states-section">
                        <div class="col-sm-12 mt-3">
                            ...
                            <?php $__currentLoopData = $states; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $state): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <span class="state-data badge" id="state_id<?php echo e($state->id); ?>" state-id="<?php echo e($state->id); ?>" onclick="fetch_data(1, '<?php echo e($state->id); ?>', '<?php echo e($state->name); ?>')" style="cursor:pointer;padding:10px 20px; margin-bottom:7px;"><?php echo e($state->name); ?></span>
