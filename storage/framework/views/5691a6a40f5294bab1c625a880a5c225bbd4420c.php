            ...
            if (status == 'Unpublish') {
              ...
              $.each(response.data.Property.property_gallery, function (key, image) {
                $("#render-images").append(`<div class="col-sm-3">
                                              <img src="<?php echo e(config('app.url')); ?>/public/${image.image_path}" style="height:50px;" />
                                            </div>`);
              });
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\web-mingo-project\prahit-properties\resources\views/admin/properties/manage_properties.blade.php ENDPATH**/ ?>