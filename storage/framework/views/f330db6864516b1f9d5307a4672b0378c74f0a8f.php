		...
		<div class="row justify-content-center">
			<div class="col-md-8 col-sm-12">
				<div class="complaint-form">
					<form method="post" action="<?php echo e(route('front.sendSummonsNotice')); ?>" id="send-query" enctype="multipart/form-data">
						<?php echo csrf_field(); ?>
						<div class="row">
							...
							<div class="col-lg-12 col-md-12">
								<div class="form-group">
									...
									<div class="d-block">
										<ul>
											<?php $__currentLoopData = $reasons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r => $reason): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<li>
												<label><input type="checkbox" name="reason[]" value="<?php echo e($reason->id); ?>"> <?php echo $reason->reason; ?></label>
											</li>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/parhitproperties/public_html/parhit-2021/resources/views/front/summons-notice.blade.php ENDPATH**/ ?>