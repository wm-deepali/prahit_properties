...
<div class="col-md-8">
    <div class="row g-4">
        ...
        <?php if(isset($property_detail->property_status)): ?>
        <div class="col-12 col-lg-3">
            <div class="detail-box text-center p-3 rounded-3 bg-light border-start border-purple border-5">
        ...
        <?php if(isset($features['Furnished Status'])): ?>
        <div class="col-12 col-lg-3">
            <div class="detail-box text-center p-3 rounded-3 bg-light border-start border-purple border-5">
        ...
        <?php if(isset($property_detail->property_status_second)): ?>
        <div class="col-12 col-lg-3">
            <div class="detail-box text-center p-3 rounded-3 bg-light border-start border-purple border-5">
...
</div><?php /**PATH D:\web-mingo-project\prahit-properties\resources\views/front/property_sections/sell_flat.blade.php ENDPATH**/ ?>