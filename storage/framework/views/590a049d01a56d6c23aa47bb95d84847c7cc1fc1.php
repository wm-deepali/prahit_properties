          ...
          <form method="post" action="<?php echo e(url('master/approve/properties')); ?>">
            ...
            <div class="container">
              ...
              <div class="row" id="publish-check">
                <p><input type="checkbox" name="publish"><b> If you also want to publish property with Approve, please
                    check the checkbox.</b></p>
              </div>
...
<?php $__env->startSection('js'); ?>
  <script type="text/javascript">
    ...
    function getPendingPropertyDatatabe(queryParams = '?') {
      var route = '<?php echo e(route('admin.properties.index')); ?>' + queryParams;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\web-mingo-project\prahit-properties\resources\views/admin/properties/pending_properties.blade.php ENDPATH**/ ?>