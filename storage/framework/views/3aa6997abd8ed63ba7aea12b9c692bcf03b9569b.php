	...
	<div class="container">
		<div class="row">
							...
							<div class="form-sep">
								...
								<div class="form-group row">
									<div class="col-sm-8">
										...
										<input type="text" class="text-control" placeholder="Title" name="title" id="title" value="<?php echo e(old('title')); ?>" required />
									</div>
									<div class="col-sm-4">
								...
								<div class="form-group row">
									<div class="col-sm-4">
										...
										<input type="number" class="text-control" placeholder="Enter Price" name="price" id="price" value="<?php echo e(old('price')); ?>" required />
									</div>
									<div class="col-md-8">
										<label class="label-control">Price Label</label>
										<ul class="price_inc" id="price_label">
											<?php if(in_array(1, old('price_label') ? old('price_label') : [])): ?>
											...
											<?php endif; ?>
											<?php if(in_array(2, old('price_label') ? old('price_label') : [])): ?>
											...
											<?php endif; ?>
											<?php if(in_array(3, old('price_label') ? old('price_label') : [])): ?>
								...
								<div class="form-group row">
									...
									<div class="col-sm-4">
										...
										<select class="text-control" name="construction_age" id="status" required="">
											<?php if(old('construction_age') == 0): ?>
												<option value="0" selected="">Ready to Move</option>
												<option value="1">Under Construction</option>
											<?php elseif(old('construction_age') == 1): ?>
								...
								<div class="form-group row">
									<div class="col-sm-12">
										...
										<textarea class="text-control" rows="2" cols="4" name="description" id="description" required=""><?php echo e(old('description')); ?></textarea>
									</div>
								</div>
								...
								<div class="form-group row">
									<div class="col-sm-12">
										...
										<input type="text" class="text-control" placeholder="Enter Address" id="address" name="address" value="<?php echo e(old('address')); ?>" required />
									</div>
								</div>
							...
							<div class="form-sep">
								...
								<div class="form-group row">
									<div class="col-sm-6">
										...
										<input type="text" class="text-control " placeholder="Enter First Name" id="firstname" name="firstname" value="<?php if(\Auth::user()): ?><?php echo e(\Auth::user()->firstname); ?><?php else: ?><?php echo e(old('firstname')); ?><?php endif; ?>" required="" />
									</div>
									<div class="col-sm-6">
										<label class="label-control">Last Name</label>
										<input type="text" class="text-control " placeholder="Enter Last Name" id="lastname" name="lastname" value="<?php if(\Auth::user()): ?><?php echo e(\Auth::user()->lastname); ?><?php else: ?><?php echo e(old('lastname')); ?><?php endif; ?>" required="" />
									</div>
								</div>
								...
								<div class="form-group row">
									<div class="col-sm-12">
										...
										<input type="email" class="text-control email" placeholder="Enter Email" id="email" name="email" value="<?php if(\Auth::user()): ?><?php echo e(\Auth::user()->email); ?><?php else: ?><?php echo e(old('email')); ?><?php endif; ?>" required="" />
									</div>
								</div>
								...
								<div class="form-group row">
									<div class="col-sm-8">
										...
										<div class="d-flex">
											<div>
												<input type="number" class="text-control mobile_number" placeholder="Enter Mobile No." value="<?php if(\Auth::user()): ?><?php echo e(\Auth::user()->mobile_number); ?><?php else: ?><?php echo e(old('mobile_number')); ?><?php endif; ?>" id="mobile_number"  name="mobile_number" required />
											</div>
											&nbsp;
									...
									<div class="col-sm-4">
										...
										<input type="text" class="text-control" placeholder="Enter OTP" id="contact_otp" name="otp" value="<?php echo e(old('otp')); ?>" required />
									</div>
								</div>
							        <div class="loading_3">
							            <img src="<?php echo e(url('/').'/public/images/loading.gif'); ?>" alt="Loading.." class="loading_3" />
							        </div>
								<?php if(!\Auth::user()): ?>
								<div class="form-group row">
									<div class="col-sm-6">
					...
					<div class="col-sm-12 mt-4 text-center">
						<div class="loading_4">
							  <img src="<?php echo e(url('/').'/public/images/loading.gif'); ?>" alt="Loading.." class="loading_4" />
						</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/parhitproperties/public_html/parhit-2021/resources/views/front/create_property.blade.php ENDPATH**/ ?>