        ...
        <div class="col-md-12 col-xs-12">
          <div class="content-header">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active">Add Furnishing status</li>
            </ol>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="main-card mb-3 card">
            <div class="card-header">Add Furnishing status</div>
            <div class="card-body">
              <form class="form form-horizontal" method="POST" action="<?php echo e(route('admin.furnishing-statuses.store')); ?>">
                <?php echo csrf_field(); ?>
                <div class="form-body" id="price-label-container">
                  ...
                  <div class="form-group row mt-3">
                    <div class="col-sm-12 text-center">
                      <button type="submit" class="btn btn-primary">Add Furnishing status</button>
                    </div>
                  </div>
                </div>
              </form>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\web-mingo-project\prahit-properties\resources\views/admin/furnishing-status/create.blade.php ENDPATH**/ ?>