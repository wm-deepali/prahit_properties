    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        <div class="content-header">
          ...
          <button class="btn btn-primary btn-save" data-target="#add-category" data-toggle="modal"><i class="fas fa-plus"></i> Add Testimonials</button>
          <ol class="breadcrumb">
            ...
            <div class="card-block">
              <div class="table-responsive">
                <table class="table table-bordered table-fitems">
                  ...
                  <tbody>
                    <?php $__currentLoopData = $testimonials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t => $testimonial): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <tr>
                        <td><?php echo e($t+1); ?></td>
                        <td><img src="<?php echo e(asset('storage/')); ?>/<?php echo e($testimonial->image); ?>" style="height: 100px;"><?php echo e($testimonial->heading); ?></td>
                        <td><?php echo e($testimonial->name); ?></td>
                        <td><?php echo e($testimonial->designation); ?></td>
                        <td><?php echo e($testimonial->description); ?></td>
                        <td><?php if($testimonial->status == 'Yes'): ?> Active <?php else: ?> Inactive  <?php endif; ?></td>
                        <td>
                          <select class="form-control" onchange="showOnFront('<?php echo e($testimonial->id); ?>')">
                                <option <?php if($testimonial->show_on_front == "No"): ?> selected <?php endif; ?>>No</option>
                                <option <?php if($testimonial->show_on_front == "Yes"): ?> selected <?php endif; ?>>Yes</option>
                            </select>
                        </td>
                        <td>
                            <ul class="action">
                              <?php if($testimonial->status == 'Yes'): ?>
                                <li><a style="cursor: pointer;" onclick="changeStatus('<?php echo e($testimonial->id); ?>')"><i class="fa fa-ban" aria-hidden="true"></i></a></li>
                              <?php else: ?>
                                <li><a style="cursor: pointer;" onclick="changeStatus('<?php echo e($testimonial->id); ?>')"><i class="fa fa-check" aria-hidden="true"></i></a></li>
                              <?php endif; ?>
                              <li><a href="#" onclick="fetchData(<?php echo e($testimonial->id); ?>);"><i class="fas fa-pencil-alt"></i></a></li>
                              <li><a href="#" data-toggle="modal" data-target="#delete-category" onclick="$('#delete_category #id').val(<?php echo e($testimonial->id); ?>)"><i class="fas fa-trash"></i></a></li>
                            </ul>
                        </td>
                      </tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content"> 
      ...
      <div class="modal-body">
        <form method="post" action="<?php echo e(route('admin.createTestimonial')); ?>" enctype="multipart/form-data">
          <?php echo csrf_field(); ?>
          <div class="form-group row">
            <div class="col-sm-12">
...
<div class="modal" id="update-testimonial">
  <div class="modal-dialog">
    <div class="modal-content"> 
      ...
      <!-- Modal body -->
      <div class="modal-body">
        <form method="post" action="<?php echo e(route('admin.updateTestimonial')); ?>" enctype="multipart/form-data">
          <?php echo csrf_field(); ?>
          <div class="form-group row">
            <div class="col-sm-12">
            ...
            <div class="col-sm-12">
              <label class="label-control">Designation</label>
              <input type="text" class="text-control" name="designation" id="designation" placeholder="Enter Designation" required />
            </div>
            <div class="col-sm-12">
              <label class="label-control">Description</label>
...
$(function() {
  ...
  $(".btn-delete").on('click', function(e) {
      ...
      var route = "<?php echo e(route('admin.deleteTestimonial', ['id' => ':id'])); ?>";
...
function fetchData(id){
  ...
  var route = "<?php echo e(route('admin.getTestimonialData', ':id')); ?>";
  var route = route.replace(":id", id);
        ...
        $.ajax({
          ...
          success: function(response) {
            ...
            if(response.status === 200) {
              ...
              document.getElementById('show-image').src = '<?php echo e(asset('storage')); ?>/'+response.data.picked.image;
...
function changeStatus(id) {
    ...
    .then((willDelete) => {
      if (willDelete) {
          ...
          $.ajax({
            url: '<?php echo e(route('admin.changeStatusTestimonial')); ?>',
            method: "POST",
            data: {
  ...
  function showOnFront(id) {
      $.ajax({
        url: '<?php echo e(route('admin.showOnFrontTestimonial')); ?>',
        method: "POST",
        data: {
          "_token": "<?php echo e(csrf_token()); ?>",
          'id'    : id
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/parhitproperties/public_html/parhit-2021/resources/views/admin/testimonial/index.blade.php ENDPATH**/ ?>