      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-4">
          <div class="call-to-action-btn text-right i-text-center">
            <form method="post" action="<?php echo e(url('post/property/final')); ?>">
              <?php echo csrf_field(); ?>
              <input type="hidden" name="property_id" value="<?php echo e($id); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/parhitproperties/public_html/parhit-2021/resources/views/property_final.blade.php ENDPATH**/ ?>