        ...
        <div class="top-bar">
            <div class="container-fluid">
                <nav class="navbar navbar-expand-lg navbar-top">
                    <a class="navbar-brand" href="<?php echo e(config('app.url')); ?>"><img src="<?php echo e(asset('images/admin-logo.png')); ?>"
                            class="img-fluid"></a>
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                                    ...
                                    <?php if(auth()->guard()->check()): ?>
                                        <span><img src="<?php echo e(asset('storage')); ?>/<?php echo e(Auth::user()->avatar); ?>"
                    ...
                    <div class="collapse navbar-collapse" id="navbar-middle">
                        <ul class="navbar-nav mr-auto">
                            <li class="nav-item active">
                                <a class="nav-link" href="<?php echo e(route('admin.dashboard')); ?>"><i
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="<?php echo e(route('admin.category.index')); ?>">Manage Property
                                        Available For</a>
                                    <a class="dropdown-item" href="<?php echo e(route('admin.sub-category.index')); ?>">Manage
                                        Category</a>
                                    <a class="dropdown-item" href="<?php echo e(route('admin.sub-sub-category.index')); ?>">Manage
                                        Property Type</a>
                                    ...
                                    <a class="dropdown-item" href="<?php echo e(route('admin.manageCities', 'all')); ?>">Manage
                                        City</a>
                                    <a class="dropdown-item" href="<?php echo e(route('admin.locations.index')); ?>">Manage
                                        Locations</a>
                                    <!--<a class="dropdown-item" href="<?php echo e(url('master/manage/sub-locations')); ?>">Manage Sub Locations</a>-->
                                    <a class="dropdown-item" href="<?php echo e(route('admin.formtype.index')); ?>">Manage Form
                                        Type</a>
                                    <a class="dropdown-item" href="<?php echo e(route('admin.manageSummonsReasons')); ?>">Summons
                                        Reasons</a>
                                    <a class="dropdown-item" href="<?php echo e(route('admin.manageAmenities')); ?>">Manage
                                        Amenities</a>
                                    <a class="dropdown-item" href="<?php echo e(route('admin.email-template.index')); ?>">Email
                                        Template Settings</a>
                                    <a class="dropdown-item" href="<?php echo e(route('admin.manageClaims')); ?>">Manage Claims</a>
                                    <a class="dropdown-item" href="<?php echo e(route('admin.price-labels.index')); ?>">Manage Price
                                        Labels</a>
                                    <a class="dropdown-item" href="<?php echo e(route('admin.property-statuses.index')); ?>">Manage
                                        Property Status</a>
                                    <a class="dropdown-item"
                                        href="<?php echo e(route('admin.registration-statuses.index')); ?>">Manage Registration
                                        Status</a>
                                    <a class="dropdown-item" href="<?php echo e(route('admin.furnishing-statuses.index')); ?>">Manage
                                        Furnishing Status</a>
                                </div>
                            </li>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="<?php echo e(route('admin.pendinPropertyList')); ?>">Pending
                                        Properties</a>
                                    <a class="dropdown-item" href="<?php echo e(route('admin.manageApprovedProperties')); ?>">Approved
                                        Properties</a>
                                    <a class="dropdown-item"
                                        href="<?php echo e(route('admin.managePublishedProperties')); ?>">Published Properties</a>
                                    <a class="dropdown-item"
                                        href="<?php echo e(route('admin.manageCancelledProperties')); ?>">Cancelled & Rejected
                                        Properties</a>
                                </div>
                            </li>
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="<?php echo e(route('admin.manage-feedback')); ?>">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="<?php echo e(route('admin.payment-gateway.index')); ?>">Payment
                                        Gateway</a>
                                    <a class="dropdown-item" href="<?php echo e(route('admin.email-integration.index')); ?>">Email
                                        Integration</a>
                                </div>
                            </li>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item"
                                        href="<?php echo e(route('admin.web-directory-category.index')); ?>">Manage Category</a>
                                    <a class="dropdown-item"
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdownPackages">
                                    <a class="dropdown-item" href="<?php echo e(route('admin.packages.index')); ?>">
                                        Manage Packages
                                    </a>
                                    <a class="dropdown-item" href="<?php echo e(route('admin.subscriptions.index')); ?>">
                                        Manage Subscriptions
                                    </a>

                                    <!-- ✅ New Payments Menu -->
                                    <a class="dropdown-item" href="<?php echo e(route('admin.payments.index')); ?>">
                                        Manage Payments
                                    </a>
                                </div>
                            </li>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="<?php echo e(url('manage/front/content')); ?>">Manage Front
                                        Sections</a>
                                    <a class="dropdown-item" href="<?php echo e(route('manageAboutContent')); ?>">About Us</a>
                                    <a class="dropdown-item" href="<?php echo e(route('manageVisionMission')); ?>">Vision &
                                        Mission</a>
                                    ...
                                    <a class="dropdown-item"
                                        href="<?php echo e(route('admin.manageTestimonial')); ?>">Testimonials</a>
                                    <a class="dropdown-item" href="<?php echo e(route('admin.manageSafetyHealth')); ?>">Safety
                                        Health</a>
                                    <a class="dropdown-item" href="<?php echo e(route('admin.manageCarrerWithUs')); ?>">Career With
                                        Us</a>
                                    <a class="dropdown-item" href="<?php echo e(route('admin.popular.cities')); ?>">Manage Popular
                                        Cities</a>
                                    <a class="dropdown-item" href="<?php echo e(route('admin.manageFeatureContent')); ?>">Manage
                                        Feature Content</a>
                                    <a class="dropdown-item" href="<?php echo e(route('admin.manageHelpContent')); ?>">Manage Help
                                        Content</a>
                                    <a class="dropdown-item" href="<?php echo e(route('admin.manageSocialMedia')); ?>">Manage Social
                                        Media</a>
                                    <a class="dropdown-item" href="<?php echo e(route('admin.manageFooterContent')); ?>">Manage Footer
                                        Content</a>
                                </div>
                            </li>
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="<?php echo e(route('admin.manageJobCategories')); ?>">Manage Job
                                        Category</a>
