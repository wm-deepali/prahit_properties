            ...
            <div class="card-block">
              <form class="form-body" id="update_property_form" name="update_property_form" enctype="multipart/form-data">
                ...
                <div class="form-group-f row">
                  <div class="col-sm-8">
                    ...
                    <input type="text" class="text-control" name="title" placeholder="Enter Property Name" value="<?php echo e($property->title); ?>" required />
                  </div>
                  <div class="col-sm-4">
              ...
              <div class="form-group-f row">
                <div class="col-sm-4">
                  ...
                  <input type="number" class="text-control" name="price" min="0" placeholder="Enter Price" value="<?php echo e($property->price); ?>" required />
                </div>
                <div class="col-md-8">
                  ...
                  <ul class="price_inc">
                    ...
                    <li><label><input type="checkbox" id="" name="price_label[]" value="<?php echo e($k); ?>" checked> <?php echo e($v); ?></label></li>
                    <?php endif; ?>
                    <?php if(!in_array($k, $db_price_labels)): ?>
                    <li><label><input type="checkbox" id="" name="price_label[]" value="<?php echo e($k); ?>"> <?php echo e($v); ?></label></li>
                    <?php endif; ?>
              ...
              <div class="form-group-f row"> 
                ...
                <div class="col-sm-3">
                  ...
                  <select class="text-control" name="construction_age" >
                    <option value="0" <?php echo e($property->construction_age == "0" ? "selected" : ""); ?>>Ready to Move</option>
                    <option value="1" <?php echo e($property->construction_age == "1" ? "selected" : ""); ?>>Under Construction</option>
                  </select>
                </div>
              </div>
              ...
              <div class="form-group-f row">
                <div class="col-sm-12">
                  ...
                  <textarea class="text-control" rows="2" cols="4" name="description" required> <?php echo e($property->description); ?></textarea>
                </div>
              </div>
              ...
              <div class="form-group-f row">
                <div class="col-sm-12">
                  ...
                  <input type="text" class="text-control" placeholder="Enter Address" id="address" name="address" value="<?php echo e($property->address); ?>" required />
                </div>
              </div>
              ...
              <div class="row form-group-f">
                ...
                <div class="col-sm-2">
                  <div class="prop-img-d">
                    <a href="<?php echo e(asset('')); ?>/<?php echo e($value->image_path); ?>" target="_blank"><img src="<?php echo e(asset('')); ?>/<?php echo e($value->image_path); ?>" alt="Property Images" class="img-fluid"></a>
                    <span onclick="deleteGalleryPhoto('<?php echo e($value->id); ?>')"><i class="fa fa-trash" aria-hidden="true"></i></span>
                  </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php else: ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/parhitproperties/public_html/parhit-2021/resources/views/admin/properties/edit.blade.php ENDPATH**/ ?>