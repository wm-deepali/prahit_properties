        ...
        <div class="col-md-12 col-xs-12">
          <div class="content-header">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active">Add Price Label</li>
            </ol>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="main-card mb-3 card">
            <div class="card-header">Add Price Label</div>
            <div class="card-body">
              <form class="form form-horizontal" method="POST" action="<?php echo e(route('admin.price-labels.store')); ?>">
                <?php echo csrf_field(); ?>
                <div class="form-body" id="price-label-container">
                  <div class="price-label-row form-group row">
                    <div class="col-md-3">
                      ...
                      <input type="text" class="form-control" placeholder="Enter Label Name" name="label_name[]" required>
                    </div>
                    <div class="col-md-3">
                  ...
                  <div class="form-group row mt-3">
                    <div class="col-sm-12 text-center">
                      <button type="submit" class="btn btn-primary">Add Price Label</button>
                    </div>
                  </div>
                </div>
              </form>
...
<?php $__env->startSection('js'); ?>
  ...
  document.getElementById('addMore').addEventListener('click', function() {
    ...
    // Update onchange for second input select
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\web-mingo-project\prahit-properties\resources\views/admin/price-label/create.blade.php ENDPATH**/ ?>