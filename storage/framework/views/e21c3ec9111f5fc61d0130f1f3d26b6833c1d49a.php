    					...
    					<div class="property-list-01">
    						<div class="property-img">
    							<a href="<?php echo e(route('property_detail', ['title' => $value->slug])); ?>"> 
    								<img src="<?php echo e(isset($value->PropertyGallery[0]->image_path) ?  asset('').$value->PropertyGallery[0]->image_path : ''); ?>" class="img-fluid"> <span class="type-pro"><?php echo e(isset($value->property_types->type) ? $value->property_types->type : ''); ?></span><span class="price-pro">Rs. <?php echo e(number_format($value->price, 2)); ?></span> 
    							</a>
    						</div>
				...
				<div class="col-lg-4 mb-3">
					<div class="project-main">
						...
						<div class="image-proj">
							<img src="<?php echo e(isset($trending->PropertyGallery[0]->image_path) ?  asset('').$trending->PropertyGallery[0]->image_path : ''); ?>" class="img-fluid">
						</div>
						
						<div class="info-proj">
							<h4 class="proj-name"><?php echo e($trending->title); ?></h4>
							<span class="apart-name"><?php echo e(\Illuminate\Support\Str::limit($trending->description, 100, $end='...')); ?></span>
							<span class="apart-adress"><?php echo e($trending->getState ? $trending->getState->name : ''); ?>, <?php echo e($trending->getCity ? $trending->getCity->name : ''); ?>, <?php echo e($trending->Location ? $trending->Location->name : ''); ?>, <?php echo e($trending->address); ?></span>
					...
					<div class="property-list-3">
						...
						<div class="listing-img-wrapper">
							<a href="<?php echo e(route('property_detail', ['title' => $featured->slug])); ?>">
								<img src="<?php echo e(isset($featured->PropertyGallery[0]->image_path) ?  asset('').$featured->PropertyGallery[0]->image_path : ''); ?>" class="img-fluid mx-auto" alt="">
							</a>
						...
						<div class="listing-content">
							<div class="listing-detail-wrapper-box">
								<div class="listing-detail-wrapper">
									<div class="listing-short-detail">
										...
										<span class="prt-types sale"><?php echo e(\Illuminate\Support\Str::limit($featured->description, 100, $end='...')); ?></span>
									</div>
							...
							<div class="listing-footer-wrapper">
								<div class="listing-locate">
									<span class="listing-location"><i class="fas fa-map-marker-alt"></i><?php echo e($featured->getState ? $featured->getState->name : ''); ?>, <?php echo e($featured->getCity ? $featured->getCity->name : ''); ?>, <?php echo e($featured->Location ? $featured->Location->name : ''); ?>, <?php echo e($featured->address); ?></span>
								</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/parhitproperties/public_html/parhit-new/resources/views/front/home.blade.php ENDPATH**/ ?>