    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="main-card mb-3 card">
          <div class="card-header">Edit Property Status</div>
          <div class="card-body">
            <form class="form form-horizontal" method="POST" action="<?php echo e(route('admin.property-statuses.update', $status->id)); ?>">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-body">
                    <div class="form-group row">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" placeholder="Enter Name" name="name" value="<?php echo e($status->name); ?>" required>
                        </div> 
                        <div class="col-md-6">
                            <label class="label-control">Input Type</label>
                            <select class="form-control" name="input_type" required>
                                <option value="">Select Input Type</option>
                                <option value="dropdown" <?php echo e($status->input_format == 'dropdown' ? 'selected' : ''); ?>>Dropdown</option>
                                <option value="checkbox" <?php echo e($status->input_format == 'checkbox' ? 'selected' : ''); ?>>Checkbox</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12 text-center mt-3">
                            <button type="submit" class="btn btn-primary">Update Property Status</button>
                        </div>
                    </div>
                </div>
            </form>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\web-mingo-project\prahit-properties\resources\views/admin/property-status/edit.blade.php ENDPATH**/ ?>