			...
			<div class="col-sm-12">
				...
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="my-account.php">My Account</a>
						</li>
								...
								<?php if(count($properties) > 0): ?>
									<?php $__currentLoopData = $properties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<div class="single-listing">
											<div class="media">
												<img class="mr-3 img-fluid" src="<?php echo e(isset($v->PropertyGallery[0]) ? url('public/
												'.$v->PropertyGallery[0]->image_path) : ''); ?>" alt="Title">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/parhitproperties/public_html/parhit-2021/resources/views/front/builder/properties.blade.php ENDPATH**/ ?>