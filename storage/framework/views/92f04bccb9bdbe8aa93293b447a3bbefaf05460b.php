...
$(function() {
  ...
  $("#feedback").DataTable({
    ...
    "serverSide": true,
    "destroy":true,
    "sAjaxSource": "<?php echo e(route('admin.propertyFeedbacks')); ?>",
    "columns": [
        {"data":"property_title"},
        {"data":"feedback"},
        {"data":"status"},
  ...
  e.preventDefault();
    ...
    console.log(queryParams);
      $("#feedback").DataTable({
        "processing": true,
        "serverSide": true,
        "sAjaxSource": "<?php echo e(route('admin.complaints.apply_filters')); ?>"+queryParams,
        "destroy":true,
        "bServerSide": true,
        "columns": [
            { "data": "id"},
...
function fetchFeedback(id){
  ...
  var route = "<?php echo e(route('admin.manage-complaints.show', ':id')); ?>";
  var route = route.replace(":id", id);
...
function fetchSubLocation(id){
  var route = "<?php echo e(route('admin.fetch_sublocations', ':id')); ?>";
  var route = route.replace(":id", id);
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/parhitproperties/public_html/parhit-2021/resources/views/admin/feedback/feedback.blade.php ENDPATH**/ ?>