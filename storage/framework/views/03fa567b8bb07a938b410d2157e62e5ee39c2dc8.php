        ...
        <div class="top-bar">
            <div class="container-fluid">
                <nav class="navbar navbar-expand-lg navbar-top">
                    <a class="navbar-brand" href="<?php echo e(config('app.url')); ?>"><img src="<?php echo e(url('/public/images/admin-logo.png')); ?>" class="img-fluid"></a>
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <?php if(auth()->guard()->check()): ?>
                                        <span><img src="<?php echo e(url('/').'/'.Auth::user()->avatar); ?>" class="img-fliud"></span> 
...
<?php echo $__env->yieldContent('js'); ?>    <?php /**PATH /home/parhitproperties/public_html/parhit-2021/resources/views/layouts/app.blade.php ENDPATH**/ ?>