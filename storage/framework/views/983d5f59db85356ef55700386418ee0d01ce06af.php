    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        <div class="content-header">
          ...
          <button class="btn btn-primary btn-save" data-target="#add-category" data-toggle="modal"><i class="fas fa-plus"></i> Add Amenities</button>
          <ol class="breadcrumb">
                      ...
                      <?php $__currentLoopData = $amenities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr id="<?php echo e($v->id); ?>">
                          ...
                          <td><ul class="action">
                              ...
                              <?php endif; ?>
                              <li><a style="cursor: pointer;" onclick="fetchData('<?php echo e($v->id); ?>');"><i class="fas fa-pencil-alt"></i></a></li>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/parhitproperties/public_html/parhit-2021/resources/views/admin/amenities/index.blade.php ENDPATH**/ ?>