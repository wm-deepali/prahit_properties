                ...
                <div class="row">
                    <div class="col-sm-12">
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <a class="navbar-brand" href="<?php echo e(url('/')); ?>"><img src="<?php echo e(URL('public/images/logo.png')); ?>" class="img-fluid"></a>

                            <div class="location-navigate">
                                <a href="#" data-toggle="modal" onclick="viewMoreCities()"><i class="fas fa-map-marker-alt"></i> <?php echo e(Cache::get('location-name')); ?></a>
                            </div>
                                ...
                                <ul class="navbar-nav m-auto mt-2 mt-lg-0">
                                    <?php if(count($categories) > 0): ?>
                                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li class="nav-item"><a class="nav-link" href="<?php echo e(url('/')); ?>?category=<?php echo e(encrypt($category->id)); ?>"><?php echo e($category->category_name); ?></a></li>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6">
                            ...
                            <center class="modal_loading">
                                <img src="<?php echo e(url('public/images/loading.gif')); ?>" alt="Loading.." class="loading" style="height: 30px;" />
                            </center>
                            <div class="modal-form">
    ...
    <div class="modal fade custom-modal" id="forgot-password" tabindex="-1" role="dialog" aria-labelledby="signin" aria-hidden="true">
        <div class="modal-dialog w-450" role="document">
            ...
            <span aria-hidden="true">&times;</span>
                ...
                <div class="top-design">
                    <img src="<?php echo e(URL::asset('public/images/top-designs.png')); ?>" class="img-fluid">
                </div>
                <div class="modal-body">
                    <div class="modal-main">
                        <center class="modal_loading">
                            <img src="<?php echo e(url('/public/images/loading.gif')); ?>" alt="Loading.." class="modal_loading" />
                        </center>
                        <div class="row login-heads">
                            <div class="col-sm-12">
                        ...
                        <div class="col-sm-4 col-xs-12">
                            <div class="input-group mb-3 search-box-city input-group-sm">
                                ...
                                <form autocomplete="off">
                                    <input type="text" class="form-control typeahead" id="search-city" placeholder="Search Your City" autocomplete="off">
                                </form>
                                <center class="modal_loading">
                                    <img src="<?php echo e(url('/public/images/loading.gif')); ?>" alt="Loading.." class="modal_loading" />
                                </center>
                        ...
                        <div class="foo-left">
                            <div class="foo-logo">
                                <a href="<?php echo e(route('home')); ?>">
                                    <img src="<?php echo e(url('public/images/logo-foo.png')); ?>" class="img-fluid">
                                </a>
...
function viewMoreCities() {
    ...
    $.ajax({
        url: '<?php echo e(route('front.getAllCities')); ?>',
        method: "GET",
        beforeSend:function() {
          $(".modal_loading").css('display', 'block');
        },
        success: function(cities) {
            $('#other-cities').empty();
                    $.each(cities, function(x,y) {
                        $('#other-cities').append(
                            '<li><a href="<?php echo e(url('/')); ?>/'+y.name+'">'+y.name+'</a></li>'
                        );
                    });
        },
        error: function(response) {
...
<?php echo $__env->yieldContent('js'); ?><?php /**PATH /home/parhitproperties/public_html/parhit-2021/resources/views/layouts/front/app.blade.php ENDPATH**/ ?>