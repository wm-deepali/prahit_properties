    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        <div class="content-header">
          ...
          <a class="btn btn-primary btn-save" href="<?php echo e(route('admin.web-directory-sub-category.create')); ?>"><i class="fas fa-plus"></i> Add Sub Category</a>
          <ol class="breadcrumb">
                    ...
                    <?php if(isset($datas) && count($datas) > 0): ?>
                      <?php $__currentLoopData = $datas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c=>$t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr id="<?php echo e($t->id); ?>">
                          ...
                          <td> <?php echo e($t->getPropertySubSubCategory ? $t->getPropertySubSubCategory->sub_sub_category_name : ''); ?> </td>
                          ...
                          <td><ul class="action">
                              <li><a href="<?php echo e(url('master/edit/sub-directory/')); ?>/<?php echo e($t->id); ?>"><i class="fas fa-pencil-alt"></i></a></li>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/parhitproperties/public_html/parhit-2021/resources/views/admin/web_directory/sub_categories/index.blade.php ENDPATH**/ ?>