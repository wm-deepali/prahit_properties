                      ...
                      <?php if(isset($subsubcategories) && count($subsubcategories) > 0): ?>
                        <?php $__currentLoopData = $subsubcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr id="<?php echo e($v->id); ?>">
                            ...
                            <td>
                              <ul class="action">
                                <li><a href="#" onclick="openModal('edit', '<?php echo e($v->id); ?>', '<?php echo e($v->category_id); ?>');"><i
                                      class="fas fa-pencil-alt"></i></a></li>
                                <!-- <li><a href="#"><i class="fas fa-times"></i></a></li> -->
                                <li><a href="#" onclick="openModal('delete', '<?php echo e($v->id); ?>');"><i class="fas fa-trash"></i></a>
                                </li>
                              </ul>
                            </td>
                          </tr>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <center class="loading">
          <img src="<?php echo e(url('/images/loading.gif')); ?>" alt="Loading.." class="loading_2" />
        </center>
...
<?php $__env->startSection('js'); ?>
  ...
  <script type="text/javascript">
    ...
    function load_subcategories(categoryId, selectedSubcategoryId = null) {
      ...
      var route = "<?php echo e(url('get/sub-categories')); ?>/" + categoryId;
      $.ajax({
        url: route,
        method: 'get',
        beforeSend: function () {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\web-mingo-project\prahit-properties\resources\views/admin/sub_sub_categories/index.blade.php ENDPATH**/ ?>