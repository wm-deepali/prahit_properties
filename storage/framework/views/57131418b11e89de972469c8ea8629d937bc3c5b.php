          ...
          <div class="card-block">
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-4">
                ...
                <h5 class="content-h">₹<?php echo e(\App\Helpers\Helper::formatIndianPrice($data->price)); ?></h5>
              </div>
            ...
            <div class="row mb-3">
              <?php if(count($data->PropertyGallery) > 0): ?>
                <?php $__currentLoopData = $data->PropertyGallery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <div class="col-sm-3">
                    <a src="<?php echo e(url('/') . '/' . $value->image_path); ?>" target="_blank">
                      <img src="<?php echo e(url('/') . '/' . $value->image_path); ?>" alt="Property Images" class="img-fluid"
            ...
            <?php if(!empty($data->property_video)): ?>
              <h3 class="mt-4">Property Video</h3>
              <div class="form-group">
                <video width="320" height="240" controls>
                  <source src="<?php echo e(url($data->property_video)); ?>" type="video/mp4">
