                  ...
                  <?php if($id != 'all' && $id != null): ?>
                    ...
                    ?>
                     <tr>
                       ...
                       <td><?php echo e($state ? $state->name : 'N/A'); ?></td>
                       <td><?php echo e($city->name); ?></td>
                       <td><?php echo e($city->location); ?></td>
                       <td>
                         <ul class="action">
                             <li><a href="<?php echo e(route('admin.locations.index', ['city_id' => $city->id])); ?>" title="Manage Locations"><i class="fa fa-list" aria-hidden="true"></i></a></li>
                             <li>
                                 <a href="#" title="Edit City" onclick="fetchData('<?php echo e($city->id); ?>')"><i class="fas fa-edit"></i></a>
                             </li>
                             <li>
                                 <a href="#" title="Delete City" onclick="deleteCity('<?php echo e($city->id); ?>')"><i class="fa fa-trash" aria-hidden="true"></i></a>
                             </li>
                         </ul>
                       </td>
                     </tr>
