                            ...
                            <td>
                              <ul class="action">
                                ...
                                <li><a href="#" data-toggle="modal" data-target="#delete-sub-category"
                                    onclick="$('#delete_sub_category #id').val(<?php echo e($t->id); ?>)"><i class="fas fa-trash"></i></a>
                                </li>
                              </ul>
                            </td>
                          </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\web-mingo-project\prahit-properties\resources\views/admin/sub_categories/index.blade.php ENDPATH**/ ?>