    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        <div class="content-header">
          ...
          <a href="<?php echo e(route('admin.registration-statuses.create')); ?>">
                      ...
                      <?php $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr>
                              ...
                              <td class="text-center btn-group-sm">
                                <ul class="action">
                                  <li>
                                    <a href="<?php echo e(route('admin.registration-statuses.edit', $status->id)); ?>">
                                      <i class="fas fa-pencil-alt"></i>
                                    </a>
                                  </li>
                                  
                                  <li>
                                    <form action="<?php echo e(route('admin.registration-statuses.destroy', $status->id)); ?>" method="POST" style="display:inline;">
                                      <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\web-mingo-project\prahit-properties\resources\views/admin/registration-status/index.blade.php ENDPATH**/ ?>