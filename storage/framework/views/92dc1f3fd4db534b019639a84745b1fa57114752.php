							...
							<div class="row">
								<div class="col-sm-7">
									...
									<div class="loc-id-detail">
										<ul>
											<li><i class="fas fa-map-marker"></i> <?php echo e(isset($property_detail->location->location) ? $property_detail->location->location : ''); ?></li>
								...
								<div class="col-sm-5">
									<div class="price-detail">
										<h3><i class="fas fa-rupee-sign"></i> <span class="property_price"> <?php echo e(isset($property_detail->price) ? number_format($property_detail->price) : ''); ?> </span> </h3>
										<a href="#property-othercharges"><i class="fas fa-info-circle"></i> Other Charges</a>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="row">
								<div class="col-sm-4">
									<div class="property-main-img">
										<img src="<?php echo e(isset($property_detail->property_gallery[0]) ? url('/public').'/'.$property_detail->property_gallery[0]->image_path : ''); ?>" class="img-fluid">
									</div>
								</div>
								...
								<div class="col-sm-8">
									<div class="property-featured-det">
										<div class="row">
											<div class="col-sm-6 col-md-6 col-xs-6">
												...
												<div class="detail-field-value"><?php echo e($property_detail->property_types ? $property_detail->property_types->type : ''); ?></div>
											</div>
										
											<div class="col-sm-6 col-md-6 col-xs-6">
												<div class="detail-field-label">State</div>
												<div class="detail-field-value"><?php echo e($property_detail->get_state ? $property_detail->get_state->name : ''); ?></div>
											</div>
											<div class="col-sm-6 col-md-6 col-xs-6">
												<div class="detail-field-label">City</div>
												<div class="detail-field-value"><?php echo e($property_detail->get_city ? $property_detail->get_city->name : ''); ?></div>
											</div>
											...
											<div class="col-sm-12 col-md-12 col-xs-6">
												<div class="detail-field-label">Age of Construction</div>
												<div class="detail-field-value">
													<?php if($property_detail->construction_age == 0): ?>  
														Ready to Move 
													<?php elseif($property_detail->construction_age == 1): ?> 
														Under Construction  
													<?php endif; ?>
												</div>
											</div>
									...
									<div class="property-featured-btn">
										<ul>
											<li><button type="button" class="btn btn-fill" data-toggle="modal" data-target="#contact-agent"  onclick='window.active_listing_id = "<?php echo e($property_detail->id); ?>"'>Contact Agent</button>
											</li>
											<li><button type="button" class="btn btn-outline" onclick="claim('<?php echo e($property_detail->id); ?>')">Claim Listing</button>
											</li>
											<li><button type="button" class="btn btn-outline" data-toggle="modal" data-target="#feedback-complaint">Feedback / Complaint</button>
											</li>
										</ul>
									</div>
								</div>
			...
			<div class="col-sm-8">
				<div class="card property-widgets">
					...
					<div class="property-gallery">
						<div class="row">
							<?php $__currentLoopData = $property_detail->property_gallery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<div class="col-sm-3">
								<a href="#">
									<img src="<?php echo e(url('/public').'/'.$v->image_path); ?>" class="img-fluid">
								</a>
							</div>
						...
						<form  method="post" action="<?php echo e(url('send/enquery')); ?>">
							...
							<div class="form-group row">
								<div class="col-sm-12">
									...
									<input type="number" class="text-control" placeholder="Enter Mobile No." min="1" value="<?php echo e(Auth::check() ? Auth::user()->mobile_number : ''); ?>" <?php echo e(Auth::check() ? "readonly" : ""); ?> name="mobile_number" required />
								</div>
							</div>
...
<div class="modal fade custom-modal" id="feedback-complaint" tabindex="-1" role="dialog" aria-labelledby="register" aria-hidden="true">
    <div class="modal-dialog w-450" role="document">
        ...
        <span aria-hidden="true">&times;</span>
            ...
            <center class="loading">
                <img src="<?php echo e(url('/public/images/loading.gif')); ?>" alt="Loading.." style="height: 30px;" class="loading" />
            </center>
                ...
                <div class="modal-main">
                    ...
                    <div class="modal-form">
                        <form method="post" action="<?php echo e(url('master/property/feedback/create')); ?>">
                            ...
                            <div class="form-group row fakelisting" style="display: none;">
                                <div class="col-sm-12">
                                    ...
                                    <ul class="no_listfeed" name="feedback">
                                        <li><label><input type="checkbox" name="complaint[]" value="1"> Property Sold/Rented Out</label></li>
                                        <li><label><input type="checkbox" name="complaint[]" value="2"> Fake/Incorrect Photos</label></li>
                                        <li><label><input type="checkbox" name="complaint[]" value="3"> Incorrect Location/Address</label></li>
                                        <li><label><input type="checkbox" name="complaint[]" value="4"> Broker property as Owner</label></li>
                                        <li><label><input type="checkbox" name="complaint[]" value="5"> Others* (Floor,Amenities,Furnished</label></li>
                                        <li><label><input type="checkbox" name="complaint[]" value="6"> Incorrect Price</label></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="form-group row notreachable" style="display: none;">
                                <div class="col-sm-12">
                                    ...
                                    <ul class="no_listfeed">
                                        <li><label><input type="checkbox" name="agent_not_reachable_type[]" value="1"> Wrong or Invalid Number</label></li>
                                        <li><label><input type="checkbox" name="agent_not_reachable_type[]" value="2"> Switched off / Not Reachable</label></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-12">
                                    <label class="label-control">That's Good! How about sharing your experience with us.</label>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-12 text-center">
                                    <button type="submit" class="btn btn-send w-100">Submit <i class="fas fa-chevron-circle-right"></i></button>
                                </div>
                            </div>
                        </form>
                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/parhitproperties/public_html/parhit-2021/resources/views/front/property_detail.blade.php ENDPATH**/ ?>