							...
							<div class="top-b-right">
								<div class="form-group row">
									<div class="col-sm-4 align-self-center">
										<div class="prop-view">
											<ul>
												<li><a href="<?php echo e(url('search/grid')); ?>?property=<?php echo e($p); ?>&type=<?php echo e($t); ?>&min_price=<?php echo e($min); ?>&max_price=<?php echo e($max); ?>" title="Grid View"><i class="fas fa-th-large"></i> Grid</a></li>
												<li><a class="active" title="List View"><i class="fas fa-list"></i> List</a></li>
											</ul>
										</div>
									</div>
									<div class="col-sm-8">
							...
							<?php $__currentLoopData = $properties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $property): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<div class="col-sm-12">
									<div class="listing-main">
										<div class="row">
											<div class="col-md-3"><img src="<?php echo e(asset('')); ?><?php echo e($property->PropertyGallery[0]->image_path); ?>" class="img-fluid" alt=""> </div>

											<div class="col-md-9 home-list-right">
												<a href="<?php echo e(url('property')); ?>/<?php echo e($property->slug); ?>"><h3><?php echo e($property->title); ?></h3></a>
												...
												<?php if(count($property->getAmenities($property->amenities))): ?>
													<div class="list-features">
														<ul>
															<?php $__currentLoopData = $property->getAmenities($property->amenities); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																<li><?php echo e($feature->name); ?></li>
															<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
														</ul>
													</div>
												<?php endif; ?>
												<div class="listing-abs">
													<ul>
														<li><a href="javascript:void(0)" title="Share Feedback/Complaint"><i class="far fa-comments"></i></a>
														</li>
														<li><a href="javascript:void(0)" title="Share Property"><i class="fas fa-share-alt"></i></a>
														</li>
													</ul>
												</div>
											</div>
											...
											<div class="col-sm-12">
												<div class="property-bottom">
													<div class="posted-detail">
														...
														?>
														<span>Posted on <?php echo e($dateTime); ?> by <?php echo e($property->getUser ? ucfirst($property->getUser->role) : ''); ?></span>
														<h3><?php echo e($property->getUser ? $property->getUser->company_name : ''); ?></h3>
													</div>
													<div class="list-enqu-btn">
														<ul>
															<li><a href="#" onclick="claim('<?php echo e($property->id); ?>')"><i class="far fa-comments"></i> Claim Listing</a> </li>
		    		...
		    		if(listings.length > 0) {
			    		...
			    		$.each(listings, function(i,row) {
			    			if(row.property_gallery[0].image_path !== ''){
				    			image_path = "<?php echo e(asset('')); ?>"+row.property_gallery[0].image_path;
			    			} else {
			    			...
			    			$("#populate_properties").append(
			    				...
			    				<div class="col-sm-12">
									<div class="listing-main">
										<div class="row">
											<div class="col-md-3"><img src=${image_path} class="img-fluid" alt=""> </div>

											<div class="col-md-9 home-list-right">
												<a href="<?php echo e(url('property')); ?>/${row.slug}"><h3>${row.title}</h3></a>
												<h4>${place}</h4>
												<ul class="listing-featured-deta">
													<li>
											...
											<div class="col-sm-12">
												<div class="property-bottom">
													<div class="posted-detail">
														<span>Posted on ${created_at} by ${role}</span>
														<h3>${company_name}</h3>
													</div>
													<div class="list-enqu-btn">
														<ul>
															<li><a style="cursor:pointer;" onclick="claim('${row.id}')"><i class="far fa-comments"></i> Claim Listing</a> </li>
			    			...
			    			$.ajax({
				                url:"<?php echo e(route('getAllAmenities')); ?>",
				                type: "POST",
				                data: {
				                    ids: ids,
				                    _token: '<?php echo e(csrf_token()); ?>',
				                ...
				                dataType : 'json',
				                success: function(result){
				                    $('#render-amenities'+i).html('');
				                    if(result.length > 0) {
				                    	$.each(result,function(key,aminity){
					                    	$("#render-amenities"+i).append('<li>'+aminity.name+'</li>');
					                    });
				                    }
				                }
				            });
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/parhitproperties/public_html/parhit-new/resources/views/front/search.blade.php ENDPATH**/ ?>