      ...
      <div class="card">
        <div class="card-body">
          <div class="card-block">
            <div class="row">
              <div class="pro-m">
                <a href="<?php echo e(url('master/update/owner/')); ?>/<?php echo e($user->id); ?>" class="btn btn-dark">Edit Profile</a>
                <a href="<?php echo e(url('master/update/owner/')); ?>/<?php echo e($user->id); ?>" class="btn btn-dark">Change Password</a>
                <a style="cursor: pointer;color: white" class="btn btn-dark" data-toggle="modal"
                  data-target="#send-sms">Send SMS</a>
                <a style="cursor: pointer;color: white" class="btn btn-dark" data-toggle="modal"
                  data-target="#send-email">Send Email</a>
              </div>

            </div>
            <div class="row" style="margin-top: 20px;">
              <?php if($user->avatar): ?>
                <?php if(file_exists(url('/') . $user->avatar)): ?>

                <?php endif; ?>
                <img src="<?php echo e(url('')); ?>/<?php echo e($user->avatar); ?>" style="height: 100px;">
              <?php endif; ?>
            </div>
            <div class="form-group row">
              <div class="col-sm-4">
                <label class="content-label">Name:</label>
                <h5 class="content-h"><?php echo e($user->firstname); ?> <?php echo e($user->lastname); ?></h5>
              </div>
              <div class="col-sm-4">
                <label class="content-label">Email:</label>
                <h5 class="content-h"><?php echo e($user->email); ?></h5>
              </div>
              <div class="col-sm-4">
                <label class="content-label">Mobile Number:</label>
                <h5 class="content-h"><?php echo e($user->mobile_number); ?></h5>
              </div>
            </div>
            <div class="form-group row">
              <div class="col-sm-4">
                <label class="content-label">State:</label>
                <h5 class="content-h"><?php echo e($user->getState ? $user->getState->name : ''); ?></h5>
              </div>
              <div class="col-sm-4">
                <label class="content-label">City:</label>
                <h5 class="content-h"><?php echo e($user->getCity ? $user->getCity->name : ''); ?></h5>
              </div>
              <div class="col-sm-4">
                <label class="content-label">Gender:</label>
                <h5 class="content-h"><?php echo e($user->gender); ?></h5>
              </div>
            </div>
            ...
            <div class="form-group row">
              <div class="col-sm-4">
                ...
                <h5 class="content-h"><?php echo e($user->address); ?></h5>
              </div>
              <div class="col-sm-4">
                <label class="content-label">Email Verified:</label>
                <h5 class="content-h"><?php if($user->is_verified == 1): ?> <span class="badge badge-success">Yes</span> <?php else: ?>
                <span class="badge badge-danger">No</span> <?php endif; ?>
                </h5>
              </div>
              <div class="col-sm-4">
                <label class="content-label">Mobile Number Verified:</label>
                <h5 class="content-h"><?php if($user->mobile_verified == 1): ?> <span class="badge badge-success">Yes</span> <?php else: ?>
                <span class="badge badge-danger">No</span> <?php endif; ?>
                </h5>
              </div>
            </div>
            ...
            <hr />
            <h4 class="form-section-h">Manage Business Listings</h4>

            <?php if($businessListings && count($businessListings) > 0): ?>
              <div class="table-responsive">
                <table class="table table-bordered table-fitems" id="business-listings">
                  <thead>
                    <tr>
                      <th>Date & Time</th>
                      <th>Business Name</th>
                  ...
                  <tbody>
                    <?php $__currentLoopData = $businessListings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $listing): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <tr>
                        <td><?php echo e($listing->created_at->format('d M Y, h:i A')); ?></td>
                        <td><?php echo e($listing->business_name); ?></td>
                        <td>
                          <?php echo e($listing->email); ?> <br>
                          <?php echo e($listing->mobile_number); ?>

                        </td>
                        <td>
                          <?php echo e($listing->category->category_name ?? '-'); ?><br />
                          <?php if($listing->subCategories && count($listing->subCategories) > 0): ?>
                            <?php echo e(implode(', ', $listing->subCategories->pluck('sub_category_name')->toArray())); ?>

                          <?php endif; ?>
                        </td>
                        <td><?php echo e($listing->total_views ?? 0); ?></td>
                        <td><?php echo e($listing->total_enquiries ?? 0); ?></td>
                        <td><?php echo e($listing->user ? $listing->user->firstname : 'Admin'); ?>

                          <?php echo e($listing->user ? $listing->user->lastname : '-'); ?></td>
                        <td>
                        ...
                        <td>
<a href="<?php echo e(route('admin.business-listing.edit', $listing->id)); ?>" class="btn btn-info btn-sm text-white">
  <i class="fas fa-edit"></i> Edit
</a>
                          <button class="btn btn-danger btn-sm" onclick="deleteBusiness(<?php echo e($listing->id); ?>)">Delete</button>
                        </td>
                      </tr>
            ...
            <?php else: ?>
              <p class="text-muted">No business listings found for this user.</p>
            <?php endif; ?>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="post" action="<?php echo e(route('admin.sendSMS')); ?>">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="id" value="<?php echo e($user->id); ?>">
            <div class="container-fluid">
              <div class="row form-group">
                <label><strong>Name:</strong></label>
                <input type="text" class="form-control" name="name" value="<?php echo e($user->firstname); ?> <?php echo e($user->lastname); ?>"
                  readonly="" required="">
              </div>
              <div class="row form-group">
                <label><strong>Mobile Number:</strong></label>
                <input type="number" class="form-control" name="number" value="<?php echo e($user->mobile_number); ?>" readonly=""
                  required="">
              </div>
              <div class="row form-group">
                <label><strong>Message:</strong></label>
                <textarea name="message" class="form-control" id="message" cols="5" onkeyup="charCount()"
                  required=""></textarea>
                <p id="char_count"></p>
              </div>
              <div class="row form-group">
  ...
  <div id="send-email" class="modal fade" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="post" action="<?php echo e(route('admin.sendEmail')); ?>">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="id" value="<?php echo e($user->id); ?>">
            <div class="container-fluid">
              <div class="row form-group">
              ...
              <div class="row form-group">
                ...
                <input type="email" class="form-control" name="email" value="<?php echo e($user->email); ?>" readonly="" required="">
              </div>
              <div class="row form-group">
                <label><strong>Message:</strong></label>
            ...
            <div class="col-sm-4 align-self-center">
              <div class="dealer-prop">
                <img
                  ...
                  id="profile-image" class="img-fluid">
              </div>
            </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-sm-12">
              <center><button class="btn btn-primary" onclick="sendInformation()" style="margin-top:15px;">Send</button>
              </center>
            </div>
          </div>
        </div>
  ...
  <script type="text/javascript">
    ...
    $(function () {
      ...
      var table = $('#total-properties').DataTable({
        ...
        render: true,
        searching: true,
        ajax: "<?php echo e(url('total/properties/datatable')); ?>?user_id=" + user_id,
        columns: [
      ...
      var table = $('#free-properties').DataTable({
        ...
        render: true,
        searching: true,
        ajax: "<?php echo e(url('total/properties/datatable')); ?>?user_id=" + user_id + "&listing_type=free",
        columns: [
          { data: 'date_time', name: 'date_time' },
          { data: 'category', name: 'category' },
          { data: 'city', name: 'city' },
      ...
      var table = $('#paid-properties').DataTable({
        ...
        render: true,
        searching: true,
        ajax: "<?php echo e(url('total/properties/datatable')); ?>?user_id=" + user_id + "&listing_type=paid",
        columns: [
          { data: 'date_time', name: 'date_time' },
          { data: 'category', name: 'category' },
          { data: 'city', name: 'city' },
      ...
      swal({
        ...
        if (willDelete) {
          $.ajax({
            ...
            error: function () {
              toastr.error("Failed to delete business listing.");
            }
          });
        }
      });
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\web-mingo-project\prahit-properties\resources\views/admin/user_view_profile.blade.php ENDPATH**/ ?>