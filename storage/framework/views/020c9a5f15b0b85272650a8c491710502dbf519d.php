        ...
        <div class="card-block">
          ...
          <div class="form-group row">
              ...
              <div class="col-sm-4">
                  ...
                  <h5 class="content-h"><?php if($user->is_verified == 1): ?> <span class="badge badge-success">Yes</span>  <?php else: ?> <span class="badge badge-danger">No</span>  <?php endif; ?></h5>
                </div>
                <div class="col-sm-4">
                  <label class="content-label">Mobile Number Verified:</label>
                  <h5 class="content-h"><?php if($user->mobile_verified == 1): ?> <span class="badge badge-success">Yes</span>  <?php else: ?> <span class="badge badge-danger">No</span>  <?php endif; ?></h5>
                </div>
          </div>
          <hr />
        ...
        <form method="post" action="<?php echo e(route('admin.sendSMS')); ?>">
          ...
          <div class="container-fluid">
            <div class="row form-group"> 
              ...
              <input type="text" class="form-control" name="name" value="<?php echo e($user->firstname); ?> <?php echo e($user->lastname); ?>" readonly="" required="">
            </div>
            <div class="row form-group"> 
              <label><strong>Mobile Number:</strong></label>
              <input type="number" class="form-control" name="number" value="<?php echo e($user->mobile_number); ?>" readonly="" required="">
            </div>
            <div class="row form-group"> 
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/parhitproperties/public_html/parhit-2021/resources/views/admin/user_view_profile.blade.php ENDPATH**/ ?>