      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="main-card mb-3 card">
            ...
            <div class="card-body">
              <form class="form form-horizontal" method="POST" action="<?php echo e(route('admin.registration-statuses.store')); ?>">
                <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\web-mingo-project\prahit-properties\resources\views/admin/registration-status/create.blade.php ENDPATH**/ ?>