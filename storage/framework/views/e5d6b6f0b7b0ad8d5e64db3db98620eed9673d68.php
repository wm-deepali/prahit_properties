  ...
  <script type="text/javascript">
    ...
    $(function () {
      ...
      $("#tableComplaints").DataTable({
        ...
        serverSide: true,
        destroy: true,
        sAjaxSource: "<?php echo e(route('admin.manage-feedback.complaints')); ?>",
      ...
      $("#tableFeedbacks").DataTable({
        ...
        serverSide: true,
        destroy: true,
        sAjaxSource: "<?php echo e(route('admin.manage-feedback.feedbacks')); ?>",
        scrollX: true,       // enable horizontal scrolling
        autoWidth: false,    // prevent auto width calculation issues
        columns: [
          { data: "property_title" },
      ...
      $("#tableAgent").DataTable({
        ...
        serverSide: true,
        destroy: true,
        sAjaxSource: "<?php echo e(route('admin.manage-feedback.agent')); ?>",
        scrollX: true,       // enable horizontal scrolling
        autoWidth: false,    // prevent auto width calculation issues
        columns: [
          { data: "property_title" },
    ...
    function changeStatus(id) {
      swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          $.ajax({
            url: '<?php echo e(route('admin.changeStatusPropertyFeedbacks')); ?>',
            method: "POST",
            data: {
    ...
    swal.fire({
        ...
        if (result.isConfirmed) {
            $(".loading_2").css('display', 'block');
            $.ajax({
                url: '<?php echo e(route("admin.manage-feedback.delete")); ?>',
                method: "POST",
                data: {
                    "_token": "<?php echo e(csrf_token()); ?>",
                    id: id
