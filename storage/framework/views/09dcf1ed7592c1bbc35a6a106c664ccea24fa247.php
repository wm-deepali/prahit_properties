      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          <div class="content-header">
            ...
            <a class="btn btn-primary btn-save" href="<?php echo e(route('admin.formtype.create')); ?>"><i class="fas fa-plus"></i> Add
              Form</a>
            <ol class="breadcrumb">
  ...
  <section class="content-main-body">
    <div class="container-fluid">
      ...
      <div class="d-flex justify-content-center mt-3">
        <?php echo e($formtypes->links('pagination::bootstrap-4')); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\web-mingo-project\prahit-properties\resources\views/admin/formtype/index.blade.php ENDPATH**/ ?>