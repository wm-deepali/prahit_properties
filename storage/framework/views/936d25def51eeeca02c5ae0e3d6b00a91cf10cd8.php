                        ...
                        <div class="category-list" id="mobile-category-list">
                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="category-wrapper">
                                    <p class="category-item" id="mobile-category-<?php echo e($category->id); ?>"
                                        data-category-id="<?php echo e($category->id); ?>"
                                        onclick="toggleCategoryMobile(this, <?php echo e($category->id); ?>)">
                                        ...
                                        <div class="subcategory-list">
                                            <?php $__currentLoopData = $category->subcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subCat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <p data-subcategory-id="<?php echo e($subCat->id); ?>"
                                                    onclick="selectSubCategoryMobile(this, <?php echo e($category->id); ?>, <?php echo e($subCat->id); ?>)">
...
<?php $__env->startSection('js'); ?>
    ...
    <script>
        ...
        function applyFiltersMobile(pageUrl = "<?php echo e(route('directory.list')); ?>") {
