  ...
  <div class="modal-dialog">
    <div class="modal-content"> 
      ...
      <div class="modal-body">
        <form method="post" action="<?php echo e(route('admin.createState')); ?>">
        <?php echo csrf_field(); ?>
...
<div class="modal update_category_modal" id="update-category">
  <div class="modal-dialog">
    <div class="modal-content"> 
      ...
      <!-- Modal body -->
      <div class="modal-body">
        <form method="post" action="<?php echo e(route('admin.updateState')); ?>">
          <div class="form-group row">
            <div class="col-sm-12">
              <label class="label-control">State Name</label>
...
//-------------------- Manage pending lead listing ----------------------//
  $(function () {
      var table = $('#states').DataTable({
          ...
          render: true,
          searching: true,
          ajax: "<?php echo e(route('admin.manageStateDatatable')); ?>",
          columns: [
  ...
  function changeStatus(id) {
    ...
    .then((willDelete) => {
      if (willDelete) {
          ...
          $.ajax({
            url: '<?php echo e(route('admin.deleteState')); ?>',
            method: "POST",
            data: {
...
function fetchData(id){
  ...
  var route = "<?php echo e(route('admin.stateInfo', ':id')); ?>";
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/parhitproperties/public_html/parhit-2021/resources/views/admin/state/index.blade.php ENDPATH**/ ?>