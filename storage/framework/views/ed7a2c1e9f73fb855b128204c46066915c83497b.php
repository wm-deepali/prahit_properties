...
<div id="admin-reply" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="container">
          <form method="post" action="<?php echo e(route('admin.replyComplaintQuery')); ?>">
            <?php echo csrf_field(); ?>
            <div class="row">
              <label>Email</label>
...
<script type="text/javascript">
  ...
  $(function () {
      var table = $('#enquiries').DataTable({
          ...
          render: true,
          searching: true,
          ajax: "<?php echo e(route('admin.manageComplaintsDatatable')); ?>",
          columns: [
  ...
  function fetchData(id){
    var route = "<?php echo e(route('admin.getComplaintData', ':id')); ?>";
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/parhitproperties/public_html/parhit-2021/resources/views/admin/enquiries/complaints.blade.php ENDPATH**/ ?>