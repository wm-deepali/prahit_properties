            ...
            <div class="card-body">
              <div class="card-block">
                <form class="form-body" method="post"
                  action="<?php echo e(url('master/web-directory-sub-category')); ?>/<?php echo e($picked->id); ?>">
                  <?php echo csrf_field(); ?>
                        ...
                        <?php if(isset($categories)): ?>
                          ...
                          <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($picked->category_id == $value->id): ?>
                              <option value="<?php echo e($value->id); ?>" cat-name="<?php echo e($value->category_name); ?>" selected="">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\web-mingo-project\prahit-properties\resources\views/admin/web_directory/sub_categories/edit.blade.php ENDPATH**/ ?>