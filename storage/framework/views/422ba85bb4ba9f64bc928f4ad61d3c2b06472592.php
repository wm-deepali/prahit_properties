  ...
  <script type="text/javascript">
      ...
      $.ajax({
        ...
        success: function (response) {
          ...
          if (response.status === 200) {
            ...
            var publish = property.publish_date ? property.publish_date : "Not Defined";
            var title = property.title || "N/A";
            var category = property.category ? property.category.category_name : "N/A";
            var subcategory = property.sub_category ? property.sub_category.sub_category_name : "N/A";
            var location = property.location ? property.location.location : "N/A";
    ...
    function manageFeaturedStatus(id) {
     ...
     function manageVerifiedStatus(id) {
      $.ajax({
        url: '<?php echo e(route('admin.manageVerifiedStatus')); ?>',
        method: "post",
        data: {
          '_token': '<?php echo e(csrf_token()); ?>',
          'id': id
