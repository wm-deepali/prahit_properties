...
<?php $__env->startSection('content'); ?>
  ...
  <section class="pricing-section">
    <h2><?php echo e($packageType === 'service' ? 'Service Provider Packages' : 'Property Packages'); ?></h2>
    <p>Compare features and choose the right plan for your <?php echo e($packageType === 'service' ? 'business' : 'property'); ?>.</p>
      ...
      <?php $__empty_1 = true; $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div class="pricing-card">
          <div class="header free">
            ...
            <button class="btn btn-primary w-100 choose-plan-btn" data-id="<?php echo e($package->id); ?>"
              data-name="<?php echo e($package->name); ?>" data-price="<?php echo e($package->price); ?>"
          ...
          <table>
            <?php if($packageType === 'service'): ?>
              ...
              <tr>
                ...
                <td><?php echo e($package->total_services ?? 'Unlimited'); ?></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td><?php echo e($package->appear_in_local_search ?? '—'); ?></td>
              </tr>
              <tr>
              ...
              <tr>
                <td>Image Upload</td>
                <td><?php echo e($package->image_upload_limit ?? '—'); ?></td>
              </tr>
              <tr>
                <td>Video Upload</td>
              ...
              <tr>
                ...
                <td><?php echo e($package->lead_enquiries ?? '—'); ?></td>
              </tr>
              <tr>
                <td>Response Rate</td>
                <td><?php echo e($package->response_rate_service ?? '—'); ?></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td><?php echo e($package->customer_support_service ?? '—'); ?></td>
              </tr>
              <tr>
            ...
            <?php else: ?>
              <tr>
                ...
                <td><?php echo e($package->number_of_listing ?? '—'); ?></td>
              </tr>
              <tr>
                <td>Photos per Listing</td>
                <td><?php echo e($package->photos_per_listing ?? '—'); ?></td>
              </tr>
              <tr>
                <td>Video Upload</td>
              ...
              <tr>
                <td>Response Rate</td>
                <td><?php echo e($package->response_rate ?? '—'); ?></td>
              </tr>
              <tr>
                <td>Property Visibility</td>
                <td><?php echo e($package->property_visibility ?? '—'); ?></td>
              </tr>
              <tr>
                <td>Verified Tag</td>
                <td><?php echo e($package->verified_tag ?? '—'); ?></td>
              </tr>
              <tr>
                <td>Premium Seller</td>
                <td><?php echo e($package->premium_seller ?? '—'); ?></td>
              </tr>
              <tr>
                <td>Profile Page</td>
                <td><?php echo e($package->profile_page ?? '—'); ?></td>
              </tr>
              <tr>
                <td>Profile Visibility</td>
                <td><?php echo e($package->profile_visibility ?? '—'); ?></td>
              </tr>
              <tr>
                <td>Profile in Search Result</td>
                <td><?php echo e($package->profile_in_search_result ?? '—'); ?></td>
              </tr>
              <tr>
                <td>Priority in Search</td>
                <td><?php echo e($package->priority_in_search ?? '—'); ?></td>
              </tr>
              <tr>
                <td>Customer Support</td>
                <td><?php echo e($package->customer_support ?? '—'); ?></td>
              </tr>
              <tr>
                <td>Lead Alerts</td>
