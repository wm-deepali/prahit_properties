  ...
  <section class="content-main-body">
    <div class="container-fluid">
                  ...
                  <table class="table table-bordered table-fitems">
                    ...
                    <tbody>
                      <?php if(isset($amenities) && count($amenities) > 0): ?>
                        <?php $__currentLoopData = $amenities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr id="<?php echo e($v->id); ?>">
                            <td><?php echo e($amenities->firstItem() + $k); ?></td>
                            <td><img src="<?php echo e(asset('storage')); ?>/<?php echo e($v->icon); ?>" style="height: 50px;"></td>
                            ...
                            <td>
                              <ul class="action">
                                <?php if($v->status == 'Yes'): ?>
                                  <li><a style="cursor: pointer;" onclick="changeStatus('<?php echo e($v->id); ?>')"><i class="fa fa-ban"
                                        aria-hidden="true"></i></a></li>
                                <?php else: ?>
                                  <li><a style="cursor: pointer;" onclick="changeStatus('<?php echo e($v->id); ?>')"><i class="fa fa-check"
                                        aria-hidden="true"></i></a></li>
                                <?php endif; ?>
                                <li><a style="cursor: pointer;" onclick="fetchData('<?php echo e($v->id); ?>');"><i
                                ...
                                <li><a href="#" data-toggle="modal" data-target="#delete-category"
                                    onclick="$('#delete_category #id').val('<?php echo e($v->id); ?>')"><i class="fas fa-trash"></i></a>
                                </li>
                              </ul>
                            </td>
                          </tr>
      ...
      <div class="d-flex justify-content-center mt-3">
        <?php echo e($amenities->links('pagination::bootstrap-4')); ?>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="post" action="<?php echo e(route('admin.createAmenities')); ?>" enctype="multipart/form-data">
  ...
  <div class="modal" id="update-category">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!-- Modal body -->
        <div class="modal-body">
          <form method="post" action="<?php echo e(route('admin.updateAmenities')); ?>" enctype="multipart/form-data">
            <div class="form-group row">
              <div class="col-sm-12">
                <label class="label-control">Icon</label>
                <p><strong>Note: Image should be 1:1 and for better result please upload 500px x 500px</strong></p>
...
<?php $__env->startSection('js'); ?>
  ...
  <script type="text/javascript">
    ...
    function fetchData(id) {
      ...
      var route = "<?php echo e(route('admin.getAmenitiesData', ':id')); ?>";
      ...
      $.ajax({
        ...
        success: function (response) {
          ...
          if (response.status === 200) {
            document.getElementById('view-icon').src = '<?php echo e(asset('storage')); ?>/' + response.data.picked.icon;
      ...
      swal({
        ...
        .then((willDelete) => {
          if (willDelete) {
            ...
            $.ajax({
              url: '<?php echo e(route('admin.chnageStatusAmenities')); ?>',
              method: "POST",
              data: {
    ...
    $(".btn-delete").on('click', function (e) {
      ...
      var route = "<?php echo e(route('admin.deleteAmenities', ['id' => ':id'])); ?>";
      var route = route.replace(':id', id);
      $.ajax({
        url: route,
        method: "DELETE",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\web-mingo-project\prahit-properties\resources\views/admin/amenities/index.blade.php ENDPATH**/ ?>