<script src="<?php echo e(asset('js/library/jquery-v3/jquery.js')); ?>"></script>
<script src="<?php echo e(asset('js/library/jquery-v3/poppers.js')); ?>"></script>
<script src="<?php echo e(asset('js/library/bootstrap-v4/bootstrap.js')); ?>"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.13.11/js/bootstrap-select.js"></script>
<script src="<?php echo e(asset('js/library/owl-carousel-v2.3/owl.carousel.min.js')); ?>"></script>
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.status === 200) {
                        ...
                        $("#change_avatar").attr('src', response.avatar_file).removeClass('hw30 br0');
                    } else {
                        toastr.error('An error occurred');
                        $("#change_avatar").attr('src', "<?php echo e(asset('storage/' . Auth::user()->avatar)); ?>").removeClass('hw30 br0');
                    }
                },
                error: function (response) {
                    ...
                    if (response.responseJSON && response.responseJSON.errors) {
                        ...
                        toastr.error('An error occurred: ' + response.responseText);
                    }
                    $("#change_avatar").attr('src', "<?php echo e(asset('storage/' . Auth::user()->avatar)); ?>").removeClass('hw30 br0');
                },
                complete: function () {
...
</script><?php /**PATH D:\web-mingo-project\prahit-properties\resources\views/layouts/front/app_js.blade.php ENDPATH**/ ?>