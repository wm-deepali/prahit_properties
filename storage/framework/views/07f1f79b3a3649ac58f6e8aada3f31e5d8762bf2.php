      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          <div class="content-header">
            ...
            <a class="btn btn-primary btn-save" href="<?php echo e(route('admin.web-directory-sub-category.create')); ?>"><i
                          ...
                          <tr id="<?php echo e($t->id); ?>">
                            ...
                            <td>
                              <?php if($t->sub_sub_category_id && count($t->sub_sub_category_id) > 0): ?>
                                <?php
                                  $subSubNames = \App\SubSubCategory::whereIn('id', $t->sub_sub_category_id)
                                    ->pluck('sub_sub_category_name')
                                    ->toArray();
                                ?>
                                <?php echo e(implode(', ', $subSubNames)); ?>
                            ...
                            <td>
                              <ul class="action">
                                <li><a href="<?php echo e(url('master/edit/sub-directory/')); ?>/<?php echo e($t->id); ?>"><i
  ...
  <script type="text/javascript">
    $(function () {
      ...
      $("#update_sub_category").validate({
        ...
        submitHandler: function () {
          $.ajax({
            url: "<?php echo e(route('admin.sub-category.update', ':id')); ?>",
            method: "PATCH",
    ...
    $(".btn-delete").on('click', function (e) {
      ...
      $.ajax({
        url: '<?php echo e(url('master/web-directory-sub-category')); ?>/' + id,
        method: "DELETE",
    ...
    function fetchData(id) {
      $.ajax({
        url: "<?php echo e(route('admin.sub-category.show', '')); ?>" + "/" + id,
        method: "GET",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\web-mingo-project\prahit-properties\resources\views/admin/web_directory/sub_categories/index.blade.php ENDPATH**/ ?>