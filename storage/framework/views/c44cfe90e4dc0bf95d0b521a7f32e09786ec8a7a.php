...
<?php $__env->startSection('title'); ?>
    <title><?php echo e($category->name); ?> FAQs - Property Questions</title>
...
<section class="faq-section">
    <div class="faq-container">
        <h1 class="faq-title"><?php echo e($category->name); ?> FAQs</h1>
        <div class="row">
            <!-- FAQs Left Column -->
            <div class="col-lg-8">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="tag-list">
                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li>
                                    <a href="<?php echo e(route('faq.category', $cat->slug)); ?>">
                                        <?php echo e($cat->name); ?>
...
<?php echo $__env->make('layouts.front.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\web-mingo-project\prahit-properties\resources\views/front/faq-category.blade.php ENDPATH**/ ?>