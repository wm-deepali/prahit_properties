                ...
                <div class="dealer-content">
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <h3 class="content-head category">--</h3>
                    </div>

                    <div class="col-sm-6">
                      <label class="content-label">Sub Category</label>
                      <h3 class="content-head subcategory">--</h3>
                    </div>
                  </div>
                ...
                <div class="dealer-content">
                  <div class="row">
                    ...
                    <div class="col-sm-12">
                      ...
                      <h3 class="content-head" id="view-email">--</h3>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <h3 class="content-head" id="view-mobile">--</h3>
                    </div>

                    <div class="col-sm-6">
                      <label class="content-label">Property Posted</label>
                      <h3 class="content-head" id="total-post-p">--</h3>
                    </div>
                  </div>
      ...
      $.ajax({
        ...
        success: function (response) {
          ...
          if (response.status === 200) {
            ...
            // Thumbnail
            if (data.property_gallery && data.property_gallery.length > 0 && data.property_gallery[0].image_path) {
              $(".listing_thumbnail").attr('src', "<?php echo e(config('app.url')); ?>/public/" + data.property_gallery[0].image_path);
            } else {
              $(".listing_thumbnail").attr('src', "<?php echo e(asset('images/default-thumbnail.png')); ?>"); // fallback image
            }
            ...
            $(".category").text(data.category ? data.category.category_name : 'N/A');
            $(".subcategory").text(data.sub_category ? data.sub_category.sub_category_name : 'N/A');

            // Location
            $(".location").text(data.location ? data.location.location : 'N/A');

            // Property ID
            $(".property_id").text(data.listing_id || 'N/A');

            // Property type
            $(".p-type").text(data.property_types ? data.property_types.type : 'N/A');

            // Price & Listing type
            $(".price").text(data.price ? '₹' + data.price : 'N/A');
            $(".listing-type").text(data.listing_type ? data.listing_type : 'N/A');

            // Published date
            $(".published_date").text(data.publish_date || 'Not Defined');
    ...
    function showOwnerInfo(id) {
      ...
      $.ajax({
        ...
        success: function (response) {
          ...
          $("#view-mobile").text(response.mobile_number);
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\web-mingo-project\prahit-properties\resources\views/admin/manage_claim.blade.php ENDPATH**/ ?>