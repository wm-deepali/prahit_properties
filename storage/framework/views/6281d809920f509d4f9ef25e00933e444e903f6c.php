...
<?php $__env->startSection('content'); ?>
      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          <div class="content-header">
            ...
            <button class="btn btn-primary btn-save" data-target="#add-location" data-toggle="modal"><i
                class="fas fa-plus"></i> Add Location</button>
            <ol class="breadcrumb">
                      ...
                      <?php if(isset($locations) && count($locations) > 0): ?>
                        <?php $__currentLoopData = $locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr id="<?php echo e($v->id); ?>">
                            ...
                            <td><a
                                href="<?php echo e(route('admin.edit_sublocation', ['id' => base64_encode($v->id)])); ?>"><?php echo e($v->sub_locations_count); ?></a>
                            </td>
                            <td>
                              <?php if($v->status == "0"): ?>
                                Active
                            ...
                            <td>
                              <ul class="action">
                                <li><a href="<?php echo e(route('admin.edit_sublocation', ['id' => base64_encode($v->id)])); ?>"
                                    title="Manage Sub Locations"><i class="fa fa-list" aria-hidden="true"></i></a></li>
                                <li><a href="#" onclick="fetchData(<?php echo e($v->id); ?>)"><i class="fas fa-pencil-alt"></i></a></li>
                                <!-- <li><a href="#"><i class="fas fa-times"></i></a></li> -->
                                <li><a href="#" data-toggle="modal" data-target="#delete-locations"
                                    onclick="$('#delete_locations #id').val(<?php echo e($v->id); ?>)"><i class="fas fa-trash"></i></a></li>
                              </ul>
                            </td>
                          </tr>
          ...
          <form id="create_location" name="create_location">
            <div class="form-group row">
              <div class="col-sm-6">
                ...
                <select class="text-control populate_states" name="state_id"
                  onchange="update_cities(this.value, (()=>{}))">
            ...
            <div class="form-group row" id="locations_container">
              <div class="col-sm-12 location-input-wrapper mb-2 d-flex align-items-center">
                <input type="text" class="text-control flex-grow-1" name="locations[]" placeholder="Enter Location Name"
                  required />
                <button type="button" class="btn btn-danger btn-sm ml-2 remove-location">Remove</button>
              </div>
            </div>

            <div class="form-group row">
              <div class="col-sm-12">
                <button type="button" id="add_more_locations" class="btn btn-secondary">Add More</button>
              </div>
            </div>
          ...
          <form id="update_locations" name="update_locations">
            ...
            <div class="form-group row">
              <div class="col-sm-6">
                ...
                <input type="text" class="text-control" placeholder="Enter Location Name" id="location" name="location"
                  required />
              </div>
              <div class="col-sm-6">
  ...
  <!-- Delete Locations Modal (unchanged) -->
...
<?php $__env->startSection('js'); ?>
  ...
  <script type="text/javascript">
    $(function () {
      ...
      // Delete Location form submission
      ...
      $('#add_more_locations').on('click', function () {
        var container = $('#locations_container');
        var newInputHTML = `
        <div class="col-sm-12 location-input-wrapper mb-2 d-flex align-items-center">
          <input type="text" class="text-control flex-grow-1" name="locations[]" placeholder="Enter Location Name" required />
          <button type="button" class="btn btn-danger btn-sm ml-2 remove-location">Remove</button>
        </div>
      `;
      ...
      // Handle remove location input
      $('#locations_container').on('click', '.remove-location', function () {
        $(this).closest('.location-input-wrapper').remove();
      });
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\web-mingo-project\prahit-properties\resources\views/admin/locations/index.blade.php ENDPATH**/ ?>