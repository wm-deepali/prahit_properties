...
$(function() {
  ...
  $(".btn-delete").on('click', function(e) {
      ...
      var route = "<?php echo e(route('admin.category.destroy', ['category' => ':id'])); ?>";
...
function fetchData(id){
  ...
  var route = "<?php echo e(route('admin.category.show', ':id')); ?>";
  var route = route.replace(":id", id);
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/parhitproperties/public_html/parhit-2021/resources/views/admin/categories/index.blade.php ENDPATH**/ ?>