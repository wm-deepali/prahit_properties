                    ...
                    <div class="collapse navbar-collapse nav-side" id="navbarSidebar">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse <?php echo e(request()->is('user/profile') || request()->is('user/my-activities') || request()->is('user/public-profile') || in_array(request('tab'), ['profile', 'security']) ? 'show' : ''); ?>"
                                    id="settingMenu">
