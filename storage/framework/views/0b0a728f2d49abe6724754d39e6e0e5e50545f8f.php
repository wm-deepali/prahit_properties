                    ...
                    <div class="collapse navbar-collapse nav-side" id="navbarSidebar">
                        <ul class="navbar-nav">
                            <li class="nav-item" style="color:#000;">
                                <a href="<?php echo e(url('user/dashboard')); ?>" class="nav-link active" style="color:#000;">Dashboard <span class="sr-only">(current)</span></a>
                            </li>
                            <!-- Setting Menu -->
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="settingMenu">
                                    <ul class="nav flex-column ml-3">
                                        ...
                                        <li class="nav-item">
                                            <a href="<?php echo e(url('user/profile')); ?>" class="nav-link">Change Password</a>
                                        </li>
                                        <li class="nav-item">
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="propertyMenu">
                                    <ul class="nav flex-column ml-3">
                                        ...
                                        <li class="nav-item">
                                            <a href="<?php echo e(url('user/all-inquries')); ?>" class="nav-link">All Inquiries</a>
                                        </li>
                                        <li class="nav-item">
