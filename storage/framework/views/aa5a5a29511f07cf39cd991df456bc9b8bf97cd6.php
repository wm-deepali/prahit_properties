      ...
      <div class="col-md-12 col-xs-12">
        <div class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">MANAGE WEB CATEGORY</li>
          </ol>
        </div>
      </div>
    </div>
                    ...
                    <?php if(isset($categories) && count($categories) > 0): ?>
                      <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr id="<?php echo e($v->id); ?>">
                          ...
                          <td><?php echo e($v->category_name); ?></td>
                          <td><?php echo e($v->category_slug); ?></td>
                          <td>
                            <?php if($v->status == "1"): ?>
                              Active
                            <?php else: ?> 
        ...
        <form id="create_category" name="create_category">
          <div class="form-group row">
            <div class="col-sm-6">
              ...
              <input type="text" class="text-control" name="category_name" placeholder="Enter Category Name" onblur="populate_slug('add_category_slug', this);" required />
            </div>
            <div class="col-sm-6">
...
$(function() {
    ...
    $("#create_category").validate({
      ...
      submitHandler:function() {
        $.ajax({
          url: "<?php echo e(route('admin.web-directory-category.store')); ?>",
          method: "POST",
    ...
    $("#update_category").validate({
      ...
      submitHandler:function() {
        $.ajax({
          url: "<?php echo e(route('admin.web-directory-category.update', '1')); ?>",
          method: "PATCH",
  ...
  $(".btn-delete").on('click', function(e) {
      ...
      var route = "<?php echo e(route('admin.web-directory-category.destroy', ':id')); ?>";
...
function fetchData(id){
        $.ajax({
          url: "<?php echo e(route('admin.web-directory-category.show', '')); ?>"+"/"+id,
          method: "GET",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/parhitproperties/public_html/parhit-2021/resources/views/admin/web_directory/categories/index.blade.php ENDPATH**/ ?>