							...
							<div class="top-b-right">
								<div class="form-group row">
									<div class="col-sm-4 align-self-center">
										<div class="prop-view">
											<ul>
												<li><a href="{{ url('search/grid') }}?property={{ $p }}&type={{ $t }}&min_price={{ $min }}&max_price={{ $max }}" title="Grid View"><i class="fas fa-th-large"></i> Grid</a></li>
							...
							@foreach($properties as $property)
								<div class="col-sm-12">
									<div class="listing-main">
										<div class="row">
											<div class="col-md-3"><img src="{{ asset('') }}{{ $property->PropertyGallery[0]->image_path }}" class="img-fluid" alt=""> </div>

											<div class="col-md-9 home-list-right">
												<a href="{{ url('property') }}/{{  $property->slug }}"><h3>{{ $property->title }}</h3></a>
												...
												@if(count($property->getAmenities($property->amenities)))
													<div class="list-features">
														<ul>
															@foreach($property->getAmenities($property->amenities) as $feature)
																<li>{{ $feature->name }}</li>
															@endforeach
														</ul>
													</div>
											...
											<div class="col-sm-12">
												<div class="property-bottom">
													<div class="posted-detail">
														...
														@endphp
														<span>Posted on {{ $dateTime }} by {{ $property->getUser ? ucfirst($property->getUser->role) : '' }}</span>
														<h3>{{ $property->getUser ? $property->getUser->company_name : '' }}</h3>
													</div>
													<div class="list-enqu-btn">
														<ul>
															<li><a href="#" onclick="claim('{{ $property->id }}')"><i class="far fa-comments"></i> Claim Listing</a> </li>
			    				...
			    				<div class="col-sm-12">
									<div class="listing-main">
										<div class="row">
											...
											<div class="col-md-9 home-list-right">
												<a href="{{ url('property') }}/${row.slug}"><h3>${row.title}</h3></a>
												<h4>${place}</h4>
												<ul class="listing-featured-deta">
													<li>
