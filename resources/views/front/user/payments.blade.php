      ...
      <div class="row">
        ...
        <div class="col-sm-9">
          ...
          <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap">
            ...
            <a href="{{ route('invoices.download_all') }}" class="btn btn-primary btn-sm mt-2 mt-sm-0">
      ...
      <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg rounded-4">
          <div class="modal-header bg-primary text-white rounded-top-4">
            <h5 class="modal-title fw-semibold" id="viewInvoiceModalLabel{{ $invoice->id }}">Invoice Details</h5>
          ...
          <div class="modal-footer">
            <a href="{{ route('invoice.download', $invoice->id) }}" class="btn btn-primary"><i
