...
@section('title')
  <title>Received Enquiries</title>
@endsection
        ...
        <div class="col-sm-12">
          ...
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">Received Enquiries</li>
            </ol>
          </nav>
        </div>
      </div>
              ...
              <tbody>
                @forelse($enquiries as $enquiry)
                  <tr>
                    ...
                    <td>
                      <span class="badge bg-info">{{ $interestedTypes[$enquiry->interested_in] ?? 'N/A' }}</span>
                    </td>
