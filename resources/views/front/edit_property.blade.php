							...
							<div class="form-sep">
								...
								<div class="form-group row">
									<div class="col-sm-8">
										...
										<input type="text" class="text-control" placeholder="Title" name="title" id="title" value="{{ $property->title }}" required />
									</div>
									<div class="col-sm-4">
								...
								<div class="form-group row">
									<div class="col-sm-4">
										...
										<input type="number" class="text-control" placeholder="Enter Price" name="price" id="price" value="{{ $property->price }}" required />
									</div>
									<div class="col-md-8">
								...
								<div class="form-group row">
									...
									<div class="col-sm-4">
										<label class="label-control">Sub Category</label>
												<select class="text-control populate_subcategories" name="sub_category_id" id="sub_category_id" required>
									...
									<div class="col-sm-4">
										...
										<select class="text-control" name="construction_age" id="status" required="">
											@if($property->construction_age == 0)
												<option value="0" selected="">Ready to Move</option>
												<option value="1">Under Construction</option>
											@elseif($property->construction_age == 1)
								...
								<div class="form-group row">
									<div class="col-sm-12">
										...
										<textarea class="text-control" rows="2" cols="4" name="description" id="description" required="">{{ $property->description }}</textarea>
									</div>
								</div>
						...
						<div class="form-group dropzone row">
							...
							@foreach($property_images as $k=>$v)
								<div class="col-sm-2">
									...
									<br>
									<center>
										<i class="fa fa-trash" aria-hidden="true" style="cursor: pointer;color: red;font-size: 15px;" onclick="deleteGalleryPhoto('{{ $v->id }}')"></i>
									</center>
								</div>
							@endforeach
						</div>
...
<!-- 								<div class="form-group mb-0 row">
								...
								<div class="form-group row">
									<div class="col-sm-6">
										...
										<input type="text" class="text-control " placeholder="Enter First Name" id="firstname" name="firstname" value="@if(\Auth::user()){{ \Auth::user()->firstname }}@else{{ old('firstname') }}@endif" required="" readonly=""/>
									</div>
									<div class="col-sm-6">
										<label class="label-control">Last Name</label>
										<input type="text" class="text-control " placeholder="Enter Last Name" id="lastname" name="lastname" value="@if(\Auth::user()){{ \Auth::user()->lastname }}@else{{ old('lastname') }}@endif" required="" readonly=""/>
									</div>
								</div>
								...
								<div class="form-group row">
									<div class="col-sm-12">
										...
										<input type="email" class="text-control email" placeholder="Enter Email" id="email" name="email" value="@if(\Auth::user()){{ \Auth::user()->email }}@else{{ old('email') }}@endif" required="" readonly=""/>
									</div>
								</div>
								...
								<div class="form-group row">
									<div class="col-sm-8">
										...
										<div class="d-flex">
											<div>
												<input type="number" class="text-control mobile_number" placeholder="Enter Mobile No." value="@if(\Auth::user()){{ \Auth::user()->mobile_number }}@else{{ old('mobile_number') }}@endif" id="mobile_number"  name="mobile_number" required readonly=""/>
											</div>
										</div>
									</div>
								</div>
					...
					<div class="col-sm-12 mt-4 text-center">
						<button class="btn btn-postproperty" type="button" onclick="createProperty()">Update Property <i class="fas fa-chevron-circle-right"></i></button>
					</div>
