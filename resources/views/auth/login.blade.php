...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('backend/css/bootstrap-4.css')}}">
        ...
        <div class="row">
            <div class="col-md-5 mx-auto">
                <div class="myform form ">
                    <div class="logo mb-3">
                        <img src="{{ asset('images/admin-logo.png')}}" class="img-fluid">
                    </div>
...
<script src="{{url('/public/backend/js/jquery.js')}}" type="text/javascript"></script>
<script src="{{url('/public/backend/js/poppers.js')}}" type="text/javascript"></script>
<script src="{{url('/backend/js/bootstrap-4.js')}}" type="text/javascript"></script>
...
$("#forgot_password_form").validate({
    submitHandler:function() {
        $.ajax({
            ...
            beforeSend: function() {
                $("#loading").html("<center> <img src='{{ URL::asset('images/loading.gif')}}' alt='loading..' /> </center> ")                
            },
