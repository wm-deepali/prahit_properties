      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          <div class="content-header">
            ...
            <a type="button" class="btn btn-primary btn-save" href="{{route('admin.properties.create')}}"><i
...
@section('js')
  <script type="text/javascript">
    ...
    function cancelledProperties(queryParams = '?') {
      var route = '{{ route('admin.manageCancelledPropertiesDatatable') }}' + queryParams;
        ...
        success: function (response) {
          ...
          if (response.status === 200) {
            ...
            if (
              ...
              $(".listing_thumbnail").attr("src", "{{ asset('images/no-image.png') }}");
            }
