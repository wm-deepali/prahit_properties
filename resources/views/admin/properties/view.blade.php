        ...
        <div class="card-block">
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-4">
              ...
              <h5 class="content-h">{{ $data->SubSubCategory ?  $data->SubSubCategory->sub_sub_category_name : 'N/A' }}</h5>
            </div>
          </div>
          <div class="row mb-3">
            <div class="col-sm-4">
          ...
          <div class="row mb-3">
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-4">
                ...
                <h5 class="content-h">{{ $data->getSubLocations($data->sub_location_id) ? $data->getSubLocations($data->sub_location_id) : 'N/A' }}</h5>
              </div>
            </div>
            <div class="row mb-3">
              <div class="col-sm-12">
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-3">
                <a href="{{ asset('') }}/{{ $value->image_path }}" target="_blank">
                  <img src="{{ asset('') }}/{{ $value->image_path }}" alt="Property Images" class="img-fluid" style="height: 100px;"></a>
              </div>
              @endforeach
              @else
