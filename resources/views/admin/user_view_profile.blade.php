          ...
          <div class="card-block">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-4">
                ...
                <h5 class="content-h">@if($user->is_verified == 1) <span class="badge badge-success">Yes</span> @else
                <span class="badge badge-danger">No</span> @endif
                </h5>
              </div>
              <div class="col-sm-4">
                <label class="content-label">Mobile Number Verified:</label>
                <h5 class="content-h">@if($user->mobile_verified == 1) <span class="badge badge-success">Yes</span> @else
                <span class="badge badge-danger">No</span> @endif
                </h5>
              </div>
            </div>
            ...
            @if($businessListings && count($businessListings) > 0)
              <div class="table-responsive">
                  ...
                  <tbody>
                    @foreach($businessListings as $listing)
                      <tr>
                        ...
                        <td>
                          {{ $listing->category->category_name ?? '-' }}<br />
                          @if($listing->subCategories && count($listing->subCategories) > 0)
                            {{ implode(', ', $listing->subCategories->pluck('sub_category_name')->toArray()) }}
                          @endif
                        </td>
          ...
          <form method="post" action="{{ route('admin.sendSMS') }}">
            ...
            <div class="container-fluid">
              ...
              <div class="row form-group">
                ...
                <input type="number" class="form-control" name="number" value="{{ $user->mobile_number }}" readonly=""
                  required="">
              </div>
              <div class="row form-group">
