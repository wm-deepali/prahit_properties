                  ...
                  <table class="table table-bordered table-fitems" id="cities">
                    ...
                    <tbody>
                      @foreach($cities as $c => $city)
                        <tr>
                          <td>{{ $cities->firstItem() + $c }}</td> <!-- Correct serial number across pages -->
                          <td>{{ $city->state ? $city->state->name : 'N/A' }}</td>
                          <td>{{ $city->name }}</td>
                          <td>{{ $city->location }}</td>
                          <td>
                            <ul class="action">
                              <li><a href="{{ route('admin.locations.index', ['city_id' => $city->id]) }}"
                                  title="Manage Locations"><i class="fa fa-list"></i></a></li>
                              <li><a href="#" title="Edit City" onclick="fetchData('{{ $city->id }}')"><i
                                    class="fas fa-edit"></i></a></li>
                              <li><a href="#" title="Delete City" onclick="deleteCity('{{ $city->id }}')"><i
