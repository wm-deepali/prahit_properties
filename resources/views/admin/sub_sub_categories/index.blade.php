                    ...
                    @if(isset($subsubcategories) && count($subsubcategories) > 0)
                      @foreach($subsubcategories as $k => $v)
                        <tr id="{{$v->id}}">
                          ...
                          <td><ul class="action">
                              <li><a href="#" onclick="openModal('edit', '{{$v->id}}', '{{$v->category_id}}');"><i class="fas fa-pencil-alt"></i></a></li>
                              <!-- <li><a href="#"><i class="fas fa-times"></i></a></li> -->
                              <li><a href="#" onclick="openModal('delete', '{{$v->id}}');"><i class="fas fa-trash"></i></a></li>
                            </ul>
                          </td>
                        </tr>
                      @endforeach
