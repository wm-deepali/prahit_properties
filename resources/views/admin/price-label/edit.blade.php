                    ...
                    <div class="form-group row">
                        <div class="col-md-6">
                            ...
                            <select class="form-control" name="second_input" id="second_input">
                                ...
                                <option value="yes" {{ $priceLabel->second_input == 'yes' ? 'selected' : '' }}>Yes</option>
                            </select>
                        </div>
                        <div class="col-md-6" id="second_input_label_div" style="display: {{ $priceLabel->second_input == 'yes' ? 'block' : 'none' }};">
