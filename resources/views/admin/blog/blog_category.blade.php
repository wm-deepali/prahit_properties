    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="post" action="{{ route('admin.storeBlogCategories') }}">
            @csrf
  ...
  <div class="modal update_category_modal" id="update-category">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!-- Modal body -->
        <div class="modal-body">
          <form method="post" action="{{ route('admin.updateBlogCategories') }}">
            <div class="form-group row">
              <div class="col-sm-12">
                <label class="label-control">Category</label>
...
@section('js')
  ...
  <script type="text/javascript">
    ...
    $(".btn-delete").on('click', function (e) {
      ...
      var route = "{{route('admin.deleteBlogCategories', ['id' => ':id'])}}";
    ...
    function fetchData(id) {
      ...
      var route = "{{route('admin.getBlogCategoryInfo', ':id')}}";
      var route = route.replace(":id", id);
    ...
    function changeStatus(id) {
      swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          $.ajax({
            url: '{{ route('admin.changeStatusBlogCategories') }}',
            method: "POST",
            data: {
              "_token": "{{ csrf_token() }}",
              'id': id
