                  ...
                  <div class="row">
                    <div class="col-sm-3">
                      ...
                      <input type="text" class="text-control" placeholder="Enter Form Name" name="form_name"
                        id="form_name" value="{{ $data->name }}" required />
                    </div>
                    <div class="col-sm-3">
                      ...
                      <div class="d-block">
                        <select class="form-control" name="assigned_to" id="category_data"
                          ...
                          @foreach($categories as $k => $v)
                            <option value="{{$v->id}}" @if(in_array($v->id, explode(',', $data->category_id))) selected
                      ...
                      <div class="d-block">
                        <select class="text-control populate_subcategories" onchange="loadSubSubcategories()"
                          ...
                          @foreach($sub_categories as $k => $v)
                            <option value="{{$v->id}}" @if(in_array($v->id, explode(',', $data->sub_category_id))) selected
                    ...
                    <div class="col-sm-3">
                      ...
                      <select class="text-control populate_subsubcategories" name="sub_sub_category_id"
                        ...
                        @foreach($sub_sub_categories as $k => $v)
                          <option value="{{$v->id}}" @if(in_array($v->id, explode(',', $data->sub_sub_category_id)))
                          selected @endif>{{$v->sub_sub_category_name}}</option>
                        @endforeach
                      </select>
                    </div>
