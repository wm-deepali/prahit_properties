    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        <div class="content-header">
          ...
          <a href="{{ route('admin.furnishing-statuses.create') }}">
                      ...
                      @foreach($statuses as $status)
                          <tr>
                              ...
                              <td class="text-center btn-group-sm">
                                <ul class="action">
                                  <li>
                                    <a href="{{ route('admin.furnishing-statuses.edit', $status->id) }}">
                                      <i class="fas fa-pencil-alt"></i>
                                    </a>
                                  </li>
                                  
                                  <li>
                                    <form action="{{ route('admin.furnishing-statuses.destroy', $status->id) }}" method="POST" style="display:inline;">
                                      @csrf
                                      @method('DELETE')
