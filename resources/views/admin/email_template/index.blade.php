      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          <div class="content-header">
            ...
            <a href="{{ route('admin.email-template.create') }}"><button class="btn btn-primary btn-save"><i
                  class="fas fa-plus"></i> Add Template</button></a>
            <ol class="breadcrumb">
                        ...
                        @foreach($templates as $template)
                          <tr>
                            ...
                            <td class="text-center btn-group-sm">
                              <ul class="action">
                                <li><a href="{{ route('admin.email-template.edit', $template->id) }}"><i
                                      class="fas fa-pencil-alt"></i></a></li>
                                @if($template->status == "active")
                                  <li><a style="cursor: pointer;" onclick="changeStatus('{{ $template->id }}')"><i
