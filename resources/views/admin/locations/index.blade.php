                    ...
                    @if(isset($locations) && count($locations) > 0)
                      @foreach($locations as $k=>$v)
                        <tr id="{{$v->id}}">
                          ...
                          <td>{{$v->Cities->name}}</td>
                          <td>{{$v->location}}</td>
                          <td><a href="{{route('admin.edit_sublocation', ['id' => base64_encode($v->id)])}}">{{$v->sub_locations_count}}</td>
                          <td>
                            @if($v->status == "0")
                              Active
                            @else 
                          ...
                          <td>
                            <ul class="action">
                              <li><a href="{{route('admin.edit_sublocation', ['id' => base64_encode($v->id)])}}" title="Manage Sub Locations"><i class="fa fa-list" aria-hidden="true"></i></a></li>
                              <li><a href="#" onclick="fetchData({{$v->id}})"><i class="fas fa-pencil-alt"></i></a></li>
                              <!-- <li><a href="#"><i class="fas fa-times"></i></a></li> -->
                              <li><a href="#" data-toggle="modal" data-target="#delete-locations" onclick="$('#delete_locations #id').val({{$v->id}})"><i class="fas fa-trash"></i></a></li>
                            </ul>
                          </td>
                        </tr>
                      @endforeach
