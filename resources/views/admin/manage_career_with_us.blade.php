                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-block">
                            <form id="edit_profile_form" class="form-body" method="post" action="{{route('admin.updateCareerWithUsContent')}}" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <input type="text" class="text-control" name="banner_heading" placeholder="Enter Heading" value="{{ $picked->heading_more }}"  />
                                    </div>
                                    <div class="col-sm-12" style="margin-top: 20px;">
                                        <label class="label label-control">Banner Description</label>
                                        <textarea name="banner_description">{{ $picked->sub_description }}</textarea>
                                    </div>
                                    <div class="col-sm-12" style="margin-top: 20px;">
