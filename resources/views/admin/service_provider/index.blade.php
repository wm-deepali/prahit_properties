                                            ...
                                            @if(isset($service_provider) && count($service_provider) > 0)
                                                @foreach($service_provider as $k => $v)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            {{ $v->businessListing ? $v->businessListing->business_name : '—' }}
                                                        </td>

                                                        <td>
                                                            {{ $v->businessListing && $v->businessListing->category ? $v->businessListing->category->category_name : '—' }}
                                                        </td>

                                                        <td>
                                                            @if($v->businessListing && $v->businessListing->services->count() > 0)
                                                                <ul class="p-0 m-0" style="list-style:none;">
                                                                    @foreach($v->businessListing->services as $service)
                                                                        <li><i class="fa fa-check text-success"></i> {{ $service->name }}
                                                                        </li>
                                                                    @endforeach
                                                                </ul>
                                                            @else
                                                            ...
                                                            <ul class="action">
                                                                ...
                                                                @else
                                                                    <li><a style="cursor: pointer;"
                                                                            ...
                                                                            title="Block User Account"><i class="fa fa-times-circle"
                                                                                aria-hidden="true"></i></a></li>
                                                                @endif
                                                                <li><a href="{{ url('user/profile') }}/{{ $v->id }}"
                                                                        title="View User Profile"><i class="fa fa-eye"
                                                                            aria-hidden="true"></i></a></li>
                                                                <li>
                                                                    <a href="{{ route('admin.business.list.by.user', $v->id) }}"
                                                                ...
                                                                @if($v->mobile_verified == 1)
                                                                    <li><a style="cursor: pointer;" title="Verify Mobile Number"
                                                                            onclick="verifyMobileNumber('{{ $v->id }}')"><i
                                                                ...
                                                                @else
                                                                    <li><a style="cursor: pointer;" title="Verify Mobile Number"
                                                                            ...
                                                                            class="logged-out">●</span></li>
                                                                @endif
                                                                <li><a href="{{ url('master/update/owner/') }}/{{ $v->id }}"
                                                                        title="Update User Profile"><i
                                                                            class="fas fa-pencil-alt"></i></a></li>
                                                                <li><a style="cursor: pointer;"
                                                                        onclick="deleteUser('{{ $v->id }}');" title="Delete User"><i
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{ url('master/create/service-providers') }}">
                        @csrf
