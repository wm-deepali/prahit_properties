      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          <div class="content-header">
            ...
            <button class="btn btn-primary btn-save" data-target="#add-reason" data-toggle="modal"><i
                class="fas fa-plus"></i> Add Feature</button>
            <ol class="breadcrumb">
                  ...
                  <table class="table table-bordered table-fitems">
                    ...
                    <tbody>
                      @foreach($features as $k => $feature)
                        <tr>
                          <td>{{ $k + 1 }}</td>
                          <td style="background-color: lightgray;"><img src="{{ asset('storage') }}/{{ $feature->image }}"
                          ...
                          <td>
                            <ul class="action">
                              @if($feature->status == 'Yes')
                                <li><a style="cursor: pointer;" onclick="changeStatus('{{ $feature->id }}')"><i
                                      class="fa fa-ban" aria-hidden="true"></i></a></li>
                              @else
                                <li><a style="cursor: pointer;" onclick="changeStatus('{{ $feature->id }}')"><i
                                      class="fa fa-check" aria-hidden="true"></i></a></li>
                              @endif
                              <li><a href="#" onclick="fetchData('{{$feature->id}}');"><i class="fas fa-pencil-alt"></i></a>
                              </li>
                              <li><a href="#" data-toggle="modal" data-target="#delete-category"
                                  onclick="$('#delete_category #id').val('{{$feature->id}}')"><i
          ...
          <form method="post" action="{{ route('admin.createFeatureContent') }}" enctype="multipart/form-data">
            ...
            <div class="form-group row">
              <div class="col-sm-12">
                ...
                <p style="color: red;"><b>Note:</b> <span>Image should be 1:1 and for better result please upload 80px x
                    80px .</span></p>
