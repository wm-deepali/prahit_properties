      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          <div class="content-header">
            ...
            <a href="{{ route('admin.createJobView') }}"><button class="btn btn-primary btn-save"><i
                  class="fas fa-plus"></i> Add Job</button></a>
            <ol class="breadcrumb">
                              ...
                              <ul class="action">
                                ...
                                @else
                                  <li><a style="cursor: pointer;" onclick="changeStatus('{{ $v->id }}')"><i class="fa fa-check"
                                        aria-hidden="true"></i></a></li>
                                @endif
                                <li><a href="#" onclick="fetchData({{$v->id}});"><i class="fa fa-eye"
                                      aria-hidden="true"></i></a></li>
