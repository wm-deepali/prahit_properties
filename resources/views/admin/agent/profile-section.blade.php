    ...
    <div class="container-fluid">
        <div class="card shadow-sm border-0">
            <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Business Profile Details - {{ $user->firstname }} {{ $user->lastname }}</h5>
                <a href="{{ route('profile.page', $user->slug ?? $user->id) }}" target="_blank" class="btn btn-light btn-sm">
                    <i class="fa fa-external-link-alt"></i> View Public Profile
                </a>
            </div>

            <div class="card-body p-4">
                <form method="POST" action="{{ route('agent.update',$user->id) }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="services-section p-3 border rounded mb-4">
                        ...
                        <div id="services-container">
                            @php $services = $profileSection->services ?? []; @endphp
