      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          <div class="content-header">
            ...
            <button class="btn btn-primary btn-save" data-target="#add-sub-category" data-toggle="modal"><i
                  ...
                  <table class="table table-bordered table-fitems">
                    ...
                    <tbody>
                      @if(isset($subcategories) && count($subcategories) > 0)
                        @foreach($subcategories as $c => $t)
                          <tr id="{{$t->id}}">
                            <td>{{ $subcategories->firstItem() + $c }}</td>
                            ...
                            <td>
                              <ul class="action">
                                <li><a href="#" onclick="fetchData({{$t->id}});"><i class="fas fa-pencil-alt"></i></a></li>
                                <!-- <li><a href="#"><i class="fas fa-times"></i></a></li> -->
                                <li><a href="#" data-toggle="modal" data-target="#delete-sub-category"
                                    onclick="$('#delete_sub_category #id').val({{$t->id}})"><i class="fas fa-trash"></i></a>
                                </li>
                              </ul>
                            </td>
                          </tr>
          ...
          <form id="create_sub_category" name="create_sub_category">
            <div class="form-group row">
              ...
              <div class="col-sm-6">
                ...
                <input type="text" class="text-control" placeholder="Enter Category Name" name="sub_category_name"
                  onchange="populate_slug('sub_category_slug', this);" required />
              </div>
            </div>
            ...
            <div class="form-group row">
              <div class="col-sm-6">
                ...
                <input type="text" class="text-control" placeholder="Enter Slug" id="sub_category_slug"
                  name="sub_category_slug" />
              </div>
              <div class="col-sm-6">
                <label class="label-control">Meta Title</label>
                <input type="text" class="text-control" placeholder="Enter Meta Title" name="sub_category_meta_title"
                  required />
              </div>
            </div>
        ...
        <div class="modal-body">
          <form id="update_sub_category" name="update_sub_category">
            <div class="form-group row">
              ...
              <div class="col-sm-6">
                <label class="label-control">Category</label>
                <input type="text" class="text-control" placeholder="Enter Category Name" id="sub_category_name"
                  name="sub_category_name" onchange="populate_slug('edit_sub_category_slug', this);" required />
              </div>
            </div>
            ...
            <div class="form-group row">
              <div class="col-sm-6">
                <label class="label-control">Slug</label>
                <input type="text" class="text-control" placeholder="Enter Slug" id="edit_sub_category_slug"
                  name="sub_category_slug" />
              </div>
              <div class="col-sm-6">
                <label class="label-control">Meta Title</label>
                <input type="text" class="text-control" placeholder="Enter Meta Title" id="sub_category_meta_title"
                  name="sub_category_meta_title" required />
              </div>
            </div>
            ...
            <div class="form-group row">
              <div class="col-sm-6">
                <label class="label-control">Meta Description</label>
                <textarea class="text-control" rows="2" cols="3" placeholder="Enter Meta Description"
                  id="sub_category_meta_description" name="sub_category_meta_description" required /></textarea>
              </div>
              <div class="col-sm-6">
                <label class="label-control">Meta Keywords</label>
                <textarea class="text-control" rows="2" cols="3" placeholder="Enter Meta Keywords"
                  id="sub_category_keywords" name="sub_category_keywords" required></textarea>
              </div>
            </div>
...
@section('js')
  ...
  <script type="text/javascript">
    $(function () {
      ...
      $("#update_sub_category").validate({
        ...
        submitHandler: function () {
          ...
          $.ajax({
            method: "PATCH",
            url: "{{url('master/sub-category')}}/" + id,
    ...
    $(".btn-delete").on('click', function (e) {
      ...
      var route = "{{route('admin.sub-category.destroy', ':id')}}";
    ...
    function fetchData(id) {
      ...
      var route = "{{route('admin.sub-category.show', ':id')}}";
      var route = route.replace(':id', id);
