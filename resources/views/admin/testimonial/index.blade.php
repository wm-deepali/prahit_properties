                ...
                <table class="table table-bordered table-fitems">
                  ...
                  <tbody>
                    @foreach($testimonials as $t => $testimonial)
                      <tr>
                        <td>{{ $t+1 }}</td>
                        <td><img src="{{ asset('storage/') }}/{{ $testimonial->image }}" style="height: 100px;">{{ $testimonial->heading }}</td>
                        ...
                        <td>
                            <ul class="action">
                              @if($testimonial->status == 'Yes')
                                <li><a style="cursor: pointer;" onclick="changeStatus('{{ $testimonial->id }}')"><i class="fa fa-ban" aria-hidden="true"></i></a></li>
                              @else
                                <li><a style="cursor: pointer;" onclick="changeStatus('{{ $testimonial->id }}')"><i class="fa fa-check" aria-hidden="true"></i></a></li>
                              @endif
                              <li><a href="#" onclick="fetchData({{$testimonial->id}});"><i class="fas fa-pencil-alt"></i></a></li>
                              <li><a href="#" data-toggle="modal" data-target="#delete-category" onclick="$('#delete_category #id').val({{$testimonial->id}})"><i class="fas fa-trash"></i></a></li>
                            </ul>
                        </td>
                      </tr>
                    @endforeach
