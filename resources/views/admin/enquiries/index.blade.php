  ...
  <script type="text/javascript">
    ...
    $(function () {
      ...
      $("#enquiries").DataTable({
        ...
        "serverSide": true,
        "destroy": true,
        "sAjaxSource": "{{ route('admin.manage-enquiries.index') }}",
        "columns": [
          { "data": "listing_id" },
          { "data": "name" },
          { "data": "mobile_number" },
    ...
    function deleteEnquiry(id) {
      ...
      var route = "{{ route('admin.manage-enquiries.destroy', ':id') }}";
        ...
        success: function (response) {
          ...
          if (response.status === 200) {
            ...
            $(".listing_thumbnail").attr('src', prop.property_gallery?.[0]?.image_path
              ? "{{config('app.url')}}/public/" + prop.property_gallery[0].image_path
