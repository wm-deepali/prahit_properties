				...
				<div class="card">
					<div class="card-body">
						<div class="card-block">
							<form class="form-body" method="post" action="{{ url('master/web-directory-sub-category') }}/{{ $picked->id }}">
              @csrf
              {{ method_field('PATCH') }}
                        ...
                        <option value="">Select Category</option>
                          ...
                          @if($picked->category_id == $value->id)
													   <option value="{{$value->id}}" cat-name="{{$value->category_name}}" selected=""> {{$value->category_name}} </option>
                          @else
                          ...
                          @endif
									...
									<div class="col-sm-4">
										...
										<input type="text" placeholder="Enter Sub Category Name" id="sub_category_name" class="text-control" onkeyup="autoFilledSlug()" name="sub_category_name" value="{{ $picked->sub_category_name }}" required />
									</div>
									<div class="col-sm-4">
										<label class="label-control">Sub Category Slug</label>
										<input type="text" placeholder="Enter Sub Category Slug" id="sub_category_slug" value="{{ $picked->sub_category_slug }}" class="text-control" name="sub_category_slug" required />
									</div>
								</div>
                  ...
                  <div class="col-sm-4">
                    ...
                    <select class="text-control populate_subsubcategories" name="sub_sub_category_id" onchange="fetch_form_type();" >
                      ...
                      @foreach($p_sub_sub_categories as $k=>$v)
                        @if($picked->sub_sub_category_id == $v->id)
