      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          <div class="content-header">
            ...
            <a class="btn btn-primary btn-save" href="{{route('admin.web-directory-sub-category.create')}}"><i
                      ...
                      @if(isset($datas) && count($datas) > 0)
                        @foreach($datas as $c => $t)
                          <tr id="{{$t->id}}">
                            ...
                            <td>
                              @if($t->sub_sub_category_id && count($t->sub_sub_category_id) > 0)
                                @php
                            ...
                            <td>
                              <ul class="action">
                                <li><a href="{{ url('master/edit/sub-directory/') }}/{{ $t->id }}"><i
