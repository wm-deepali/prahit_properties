...
$(function() {
    ...
    $("#create_category").validate({
      ...
      submitHandler:function() {
        $.ajax({
          url: "{{route('admin.web-directory-category.store')}}",
          method: "POST",
    ...
    $("#update_category").validate({
      ...
      submitHandler:function() {
        $.ajax({
          url: "{{route('admin.web-directory-category.update', '1')}}",
          method: "PATCH",
  ...
  $(".btn-delete").on('click', function(e) {
      ...
      var route = "{{route('admin.web-directory-category.destroy', ':id')}}";
...
function fetchData(id){
        $.ajax({
          url: "{{route('admin.web-directory-category.show', '')}}"+"/"+id,
          method: "GET",
