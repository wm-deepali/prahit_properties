                        ...
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="location-navigate">
                                <a href="javascript:void(0)" data-toggle="modal" onclick="viewMoreCities()"><i
                                        class="fas fa-map-marker-alt"></i> {{ Cache::get('location-name') }}</a>
                            </div>
                            ...
                            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                                ...
                                <ul class="navbar-nav m-auto mt-2 mt-lg-0">
                                    <li class="nav-item"><a class="nav-link"
                                            href="{{ url('/') }}/{{ Cache::get('location-name') ? Cache::get('location-name') : '' }}?category={{ encrypt(22) }}">Buy</a>
                                    </li>
                                    <li class="nav-item"><a class="nav-link"
                                            href="{{ url('/') }}/{{ Cache::get('location-name') ? Cache::get('location-name') : '' }}?category={{ encrypt(21) }}">Rent</a>
                                    </li>
                                    <li class="nav-item"><a class="nav-link"
                                            href="{{ url('/') }}/{{ Cache::get('location-name') ? Cache::get('location-name') : '' }}?category={{ encrypt(20) }}">PG / Hostel</a>
                                    </li>
                                </ul>
                                    ...
                                    <ul class="side-btn">
                                        @auth
                                            @if(\Auth::user()->role == 'owner')
                                                <li><a href="{{url('user/dashboard')}}"><i class="far fa-user"></i>
                                                        {{Auth::user()->firstname}} {{Auth::user()->lastname}}</a></li>
                                            @elseif(\Auth::user()->role == 'builder')
                                                <li><a href="{{url('builder/dashboard')}}"><i class="far fa-user"></i>
                                                        {{Auth::user()->firstname}} {{Auth::user()->lastname}}</a></li>
                                            @elseif(\Auth::user()->role == 'agent')
                                                <li><a href="{{url('agent/dashboard')}}"><i class="far fa-user"></i>
                                                        {{Auth::user()->firstname}} {{Auth::user()->lastname}}</a></li>
                                            @endif
                                        ...
                                        @endguest
                                        <li><a href="{{route('create_property')}}"><i class="fas fa-pencil-alt"></i>
