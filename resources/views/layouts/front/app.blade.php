    ...
    <div class="d-flex justify-content-between align-items-center p-2">
      <div class="d-flex align-items-center gap-2">
        ...
        <a class="navbar-brand me-3" href="{{ url('/') }}">
          <img src="{{ asset('images/logoicon.png') }}" alt="Logo" style="height:30px;">
        </a>
      </div>
                  ...
                  <div class="tab-content-section">
                    ...
                    <div class="d-flex flex-column">
                      @foreach ($sellResidentil as $key => $subSubcat)
                        <a
                          href="{{ route('listing.list', ['type' => 'buy', 'sub_category_id' => $subSubcat->sub_category_id, 'sub_sub_category_id' => $subSubcat->id]) }}">
                  ...
                  <div class="tab-content-section">
                    ...
                    <div class="d-flex flex-column">
                      @foreach ($rentResidentil as $subSubcat)
                        <a
                          href="{{ route('listing.list', ['type' => 'rental', 'sub_category_id' => $subSubcat->sub_category_id, 'sub_sub_category_id' => $subSubcat->id]) }}">
                          {{ $subSubcat->sub_sub_category_name }}
                        </a>
                        <div style="width: 100%; height: 1px; background: #e6e6e6; margin: 3px 0;"></div>
                      @endforeach
                  ...
                  <div id="buyersNewLaunchCollapse" class="accordion-collapse collapse"
                    ...
                    <div class="accordion-body">
                      <div class="sub-sub-section section-properties">
                        ...
                        <ul class="list-unstyled">
                          <li><a
                              href="{{ route('listing.list', ['type' => 'buy', 'sub_category_id' => 34]) }}">Residential
                              Projects</a>
                          </li>
                          <li><a
                              href="{{ route('listing.list', ['type' => 'buy', 'sub_category_id' => 35]) }}">Commercial
                              Projects</a>
                          </li>
                          <li><a
                              href="{{ route('listing.list', ['type' => 'buy', 'sub_sub_category_id' => '18,25,27']) }}">Land
                              &
                              Plots</a></li>
                        </ul>
                      </div>
                      <div class="sub-sub-section section-budget">
                        ...
                        <ul class="list-unstyled">
                          @foreach ($sellBudgets as $budget)
                            <li><a
                                href="{{ route('listing.list', array_merge(['type' => 'buy', 'category_id' => 22], $budget['query'])) }}">
                                {{ $budget['label'] }}</a></li>
                          @endforeach
                        </ul>
                      </div>
                    ...
                    <div class="accordion-body">
                      ...
                      <div class="sub-sub-section section-budget">
                        ...
                        <ul class="list-unstyled">
                          @foreach ($rentBudgets as $budget)
                            <li><a
                                href="{{ route('listing.list', array_merge(['type' => 'rental','sub_category_id' => 38], $budget['query'])) }}">
                                {{ $budget['label'] }}</a></li>
                          @endforeach
                        </ul>
                      </div>
                      ...
                      <div class="sub-sub-section section-popular">
                        ...
                        <ul class="list-unstyled">
                          ...
                          <li><a
                              ...
                              Properties</a></li>
                          <li><a
                              href="{{ route('listing.list', ['type' => 'rental','sub_category_id' => 37, 'property_status' => 'Ready to Move'])}}">Ready
                              to
                              Move</a></li>
                          <li><a href="#">Immediate Available</a></li>
                          <li> <a
                              href="{{ route('listing.list', ['type' => 'rental','sub_category_id' => 37, 'furnishing_status' => 'Full Furnished'])}}">Full
                              Furnished</a></li>
                        </ul>
                      </div>
                    </div>
                ...
                <div class="form-group row">
                  <div class="col-sm-12">
                    ...
                    <input type="text" class="text-control" placeholder="Enter Name" name="name"
                      value="{{Auth::check() ? Auth::user()->firstname : ''}}" {{Auth::check() ? "readonly" : "" }}
                      required />
                  </div>
                </div>
                ...
                <div class="form-group row">
                  <div class="col-sm-12">
                    ...
                    <input type="number" class="text-control" placeholder="Enter Mobile No." name="mobile_number"
                      value="{{Auth::check() ? Auth::user()->mobile_number : ''}}" {{Auth::check() ? "readonly" : "" }}
                      required />
                  </div>
                </div>
