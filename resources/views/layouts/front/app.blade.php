                    ...
                    <div class="col-sm-12">
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="location-navigate">
                                <a href="javascript:void(0)" data-toggle="modal" onclick="viewMoreCities()"><i class="fas fa-map-marker-alt"></i> {{ Cache::get('location-name') }}</a>
                            </div>
                                ...
                                <ul class="navbar-nav m-auto mt-2 mt-lg-0">
                                    @if(count($categories) > 0)
                                        @foreach($categories as $category)
                                            <li class="nav-item"><a class="nav-link" href="{{ url('/') }}/{{ Cache::get('location-name') ? Cache::get('location-name') : '' }}?category={{ encrypt($category->id) }}">{{ $category->category_name }}</a></li>
                                        @endforeach
                                    @endif
                                </ul>
                                    ...
                                    <ul class="side-btn">
                                        @auth
                                            @if(\Auth::user()->role == 'owner')
                                                <li><a href="{{url('user/dashboard')}}"><i class="far fa-user"></i> {{Auth::user()->firstname}} {{Auth::user()->lastname}}</a></li>
                                            @elseif(\Auth::user()->role == 'builder')
                                                <li><a href="{{url('builder/dashboard')}}"><i class="far fa-user"></i> {{Auth::user()->firstname}} {{Auth::user()->lastname}}</a></li>
                                            @elseif(\Auth::user()->role == 'agent')
                                                <li><a href="{{url('agent/dashboard')}}"><i class="far fa-user"></i> {{Auth::user()->firstname}} {{Auth::user()->lastname}}</a></li>
                                            @endif
                                        ...
                                        @endguest
                                        <li><a href="{{route('create_property')}}"><i class="fas fa-pencil-alt"></i> Post Property <span>FREE</span></a></li>
                        ...
                        <form id="contact_agent_form_modal" name="contact_agent_form_modal">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-12">
                                    ...
                                    <input type="number" class="text-control" placeholder="Enter Mobile No." name="mobile_number" value="{{Auth::check() ? Auth::user()->mobile_number : ''}}" {{Auth::check() ? "readonly" : "" }} required />
                                </div>
                            </div>
                        ...
                        <div class="foo-left">
                            ...
                            <div class="foo-social-app">
                                <ul>
                                    ...
                                    <li><a href="{{ $media->twitter }}" target="_blank"><i class="fab fa-twitter"></i></a>
                                    </li>
                                    <li><a href="{{ $media->insta }}" target="_blank"><i class="fab fa-instagram"></i></a>
                                    </li>
                                    <li><a href="{{ $media->youtube }}" target="_blank"><i class="fab fa-youtube"></i></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
