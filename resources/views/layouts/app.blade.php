        ...
        <div class="top-bar">
            <div class="container-fluid">
                <nav class="navbar navbar-expand-lg navbar-top">
                    <a class="navbar-brand" href="{{config('app.url')}}"><img src="{{ asset('images/admin-logo.png')}}" class="img-fluid"></a>
                        ...
                        <ul class="navbar-nav ml-auto">
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    @auth
                                        <span><img src="{{ asset('storage') }}/{{ Auth::user()->avatar }}" class="img-fliud"></span> 
                                        {{Auth::user()->firstname}}
                                    @endauth
                                    @guest
                        ...
                        <ul class="navbar-nav mr-auto">
							...
							<li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="{{route('admin.manageSummonsReasons')}}">Summons Reasons</a>
							...
							<li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{route('admin.pendinPropertyList')}}">Pending Properties</a>
                                    <a class="dropdown-item" href="{{route('admin.manageApprovedProperties')}}">Approved Properties</a>
                                    <a class="dropdown-item" href="{{route('admin.managePublishedProperties')}}">Published Properties</a>
                                    <a class="dropdown-item" href="{{route('admin.manageCancelledProperties')}}">Cancelled & Rejected Properties</a>
                                </div>
                            </li>
							<li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{route('admin.manage-enquiries.index')}}"> Property Enquiries</a>
                                    <a class="dropdown-item" href="{{url('master/property/feedback')}}"> Feedbacks</a>
                                    <a class="dropdown-item" href="{{route('admin.manage-complaints.index')}}"> Property Complaints</a>
                                    <a class="dropdown-item" href="{{route('admin.manageSupportQuery')}}"> Support Center</a>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="{{route('admin.payment-gateway.index')}}">Payment Gateway</a>
                                    <a class="dropdown-item" href="{{route('admin.email-integration.index')}}">Email Integration</a>
                                </div>
                            </li>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{url('manage/front/content')}}">Manage Front Sections</a>
                                    <a class="dropdown-item" href="{{route('manageAboutContent')}}">About Us</a>
                                    <a class="dropdown-item" href="{{route('manageVisionMission')}}">Vision & Mission</a>
                                    ...
                                    <a class="dropdown-item" href="{{route('admin.manageTestimonial')}}">Testimonials</a>
                                    <a class="dropdown-item" href="{{route('admin.manageSafetyHealth')}}">Safety Health</a>
                                    <a class="dropdown-item" href="{{route('admin.manageCarrerWithUs')}}">Career With Us</a>
                                    <a class="dropdown-item" href="{{route('admin.popular.cities')}}">Manage Popular Cities</a>
                                    <a class="dropdown-item" href="{{route('admin.manageFeatureContent')}}">Manage Feature Content</a>
                                    <a class="dropdown-item" href="{{route('admin.manageHelpContent')}}">Manage Help Content</a>
                                    <a class="dropdown-item" href="{{route('admin.manageSocialMedia')}}">Manage Social Media</a>
                                    <a class="dropdown-item" href="{{route('admin.manageFooterContent')}}">Manage Footer Content</a>
                                </div>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{route('admin.manageJobCategories')}}">Manage Job Category</a>
                                    <a class="dropdown-item" href="{{route('admin.manageJobTechnologies')}}">Manage Technologies</a>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{route('admin.manageBlogCategories')}}">Manage Blog Category</a>
