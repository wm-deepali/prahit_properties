...
class ServiceProviderController extends Controller
{
    ...
    {
        $service_provider = User::where('role', 'service_provider')
            ->with(['businessListing.services', 'businessListing.category'])
            ->orderBy('id', 'DESC')
            ->get();
        return view('admin.service_provider.index', compact('service_provider'));
    }
