...
class StateController extends Controller
{
    ...
    public function manageCities($id = null)
    {
        ...
        if ($id && $id != 'all') {
            $cities = City::with('state')->where('state_id', $id)->paginate(10); // paginate 10 per page
        } else {
            $cities = City::with('state')->orderBy('id', 'ASC')->paginate(10);
        }

        return view('admin.state.manage_cities', compact('id', 'states', 'cities'));
    }
